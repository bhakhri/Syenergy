...
if(trim($REQUEST_DATA['classId'] ) != '' && trim($REQUEST_DATA['employeeId'] ) != '') {
    $foundArray = AdminTasksManager::getInstance()->getTeacherSubject(' AND c.classId='.$REQUEST_DATA['classId']);
