...
if(trim($REQUEST_DATA['subjectId'])!= '' and trim($REQUEST_DATA['classId'])!= '' and trim($REQUEST_DATA['employeeId'])!='' and trim($REQUEST_DATA['timeTableLabelId'])!='' ) {
    ...
    if (in_array(1,$groupTypeIdListArray)) {
        ...
        $foundArray = $teacherManager->getSubjectGroup($REQUEST_DATA['subjectId'],$REQUEST_DATA['classId'], " AND g.groupTypeId = 1 ",$timeTableConditions);
    }
    elseif (in_array(2,$groupTypeIdListArray)) {
        //for practical, pick only practical groups
        $foundArray = $teacherManager->getSubjectGroup($REQUEST_DATA['subjectId'],$REQUEST_DATA['classId'], " AND g.groupTypeId = 2 ",$timeTableConditions);
    }
    else {
        ...
        if ($groupTypeId == 3) {
            $foundArray = $teacherManager->getSubjectGroup($REQUEST_DATA['subjectId'],$REQUEST_DATA['classId'], " AND g.groupTypeId = ".$groupTypeId,$timeTableConditions);
...
//
//*****************  Version 1  *****************
//User: Dipanjan     Date: 14/12/09   Time: 13:50
