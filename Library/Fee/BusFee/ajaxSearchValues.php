...
//--------------------------------------------------------
    ...
    if($searchMode=='all') {
      ...
      $degreeArray =  $busFeeManager->getAllSearchValue($fieldName,$condition);
    }
    ...
    if($searchMode=='all' || $searchMode=='Degree') {
      ...
      $branchArray =  $busFeeManager->getAllSearchValue($fieldName,$condition1);
    ...
    if($searchMode=='all' || $searchMode=='Branch') {
      ...
      $batchArray =  $busFeeManager->getAllSearchValue($fieldName,$condition1);
    }
    ...
    if($searchMode=='all' || $searchMode=='Batch') {
      ...
      $classArray =  $busFeeManager->getAllSearchValue($fieldName,$condition1);
      $searchMode = "all";
    }
