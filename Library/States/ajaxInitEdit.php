...
UtilityManager::headerNoCache();
    ...
    if (trim($errorMessage) == '') {
        ...
        $foundArray = StatesManager::getInstance()->getState(' WHERE (UCASE(stateCode)="'.add_slashes(strtoupper($REQUEST_DATA['stateCode'])).'" OR LCASE(stateName)= "'.add_slashes(trim(strtolower($REQUEST_DATA['stateName']))).'") AND countryId = '.trim($REQUEST_DATA['countries']).' AND stateId!='.$REQUEST_DATA['stateId']);
...
//
//*****************  Version 2  *****************
//User: Jaineesh     Date: 6/11/09    Time: 4:23p
//Updated in $/LeapCC/Library/States
//modified in condition while sending at edit
//
//*****************  Version 1  *****************
