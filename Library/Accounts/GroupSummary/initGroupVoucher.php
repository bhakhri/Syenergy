<?php
//-------------------------------------------------------
//  This File contains logic for groups vouchers
//
//
...
//--------------------------------------------------------
	...
	$module = 'GroupVoucher_'.$groupId;

	$drillLink = "<a href='listGroupVoucherDisplay.php?id=$groupId&date=$tillDate'>Group Voucher</a>";
	...
	$ledgerArray = $voucherManager->getGroupTreeLedgers($groupId);
	$ledgerId = UtilityManager::makeCSList($ledgerArray, 'ledgerId');
