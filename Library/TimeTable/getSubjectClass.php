...
if(trim($REQUEST_DATA['classId'] ) != '') {
    ...
    $foundArray = $timeTableManager->getSubjectClassFromTimeTable(' sub.subjectCode ',' AND ttc.classId='.$REQUEST_DATA['classId'].' AND t.daysOfWeek = '.$getDay.' AND stc.classId = '.$REQUEST_DATA['classId']);
