...
require_once(MODEL_PATH . "/TimeTableManager.inc.php");
    ...
    $filter= "DISTINCT  tt.subjectId, CONCAT(sub.subjectName,' (',sub.subjectCode,')') AS subjectName ";
...
// $History: ajaxGetTeacherSubjects.php $
//
//*****************  Version 3  *****************
...
//
//*****************  Version 2  *****************
//User: Parveen      Date: 2/19/10    Time: 4:52p
//Updated in $/LeapCC/Library/TimeTable
