...
require_once(MODEL_PATH . "/TimeTableConflictManagerDayWise.inc.php");
$timeTableConflictManager = TimeTableConflictManagerDayWise::getInstance();
...
*/
// $History: ajaxInitSaveAdvancedDayWise.php $
//
//*****************  Version 1  *****************
//User: Ajinder      Date: 4/17/10    Time: 4:34p
