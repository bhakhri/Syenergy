...
UtilityManager::headerNoCache();
    ...
    if (trim($errorMessage) == '') {
        ...
        $foundArray = CityManager::getInstance()->getCity(' WHERE ( stateId='.trim($REQUEST_DATA['states']).' AND ( UCASE(cityCode)="'.add_slashes(strtoupper(trim($REQUEST_DATA['cityCode']))).'" OR UCASE(cityName)="'.add_slashes(strtoupper(trim($REQUEST_DATA['cityName']))).'" ) ) AND cityId!='.$REQUEST_DATA['cityId']);
