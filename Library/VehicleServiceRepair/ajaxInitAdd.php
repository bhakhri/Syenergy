...
//--------------------------------------------------------
	...
	$serviceDate = $REQUEST_DATA['serviceDate'];
	...
	if(SystemDatabaseManager::getInstance()->startTransaction()) {
		...
		$insertVehicleServiceRepair = $vehicleServiceRepairManager->insertVehicleServiceRepair();
		if($insertVehicleServiceRepair === false) {
			$errorMessage = FAILURE;
		}

		$serviceRepairId=SystemDatabaseManager::getInstance()->lastInsertId();
