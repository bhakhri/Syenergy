...
if(trim($REQUEST_DATA['messageId'] ) != '') {
	...
	//if($roleArr[1]==4){		 
	//	$foundArray = StudentTeacherManager::getInstance()->getStudentMessageDetail1(' AND stc.messageId="'.$roleArr[0].'"');
    // } 	
    $foundArray = $adminMessageManager->getParentTeacherAdminList(' AND stc.messageId="'.$messageId.'"');
...
// $History: ajaxGetStudentTeacherValues1.php $
//
//*****************  Version 6  *****************
