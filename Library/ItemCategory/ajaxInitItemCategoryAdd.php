...
UtilityManager::headerNoCache();
    ...
    if (trim($errorMessage) == '') {
        ...
        $foundArray = ItemCategoryManager::getInstance()->getItemCategory(' WHERE UCASE(categoryName)= "'.add_slashes(trim(strtoupper($REQUEST_DATA['categoryName']))).'" OR UCASE(abbr)="'.add_slashes(strtoupper($REQUEST_DATA['abbr'])).'"');
