...
//----------------------------------------------------------------------------------------------------------------------
    ...
    //fetch active time table label id
    $timeTableLabelArray = $teacherManager->getActiveTimeTableLabel();
    $timeTableLabelId    = $timeTableLabelArray[0]['timeTableLabelId'];
    ...
    for($i=0;$i<$cnt;$i++) {
        ...
        $studentRecordArray[$i]['comments']='<input type="text" class="inputbox"    style="width:310px;" name="leavesComment" id="leavesComment'.$i.'" alt="'.$alt.'" value="'.$comments.'" maxlength="255" />'.$hiddenString;
