      ...
      if($cnt>0) {
         ...
         if($groupTypeId==1 || $groupTypeId==3) {
           ...
           // Date format
              ...
              $fieldName  = " DISTINCT  att.fromDate, att.toDate "; 
              $fieldName .= " ,IFNULL(periodNumber,'') AS periodNumber "; 
                            ...
                            for($j=0; $j<$countColumns; $j++) {
                               ...
                               if($aFromDate==$dFromDate && $aToDate==$dToFromDate && $aPeriodNumber==$dPeriodNumber) {
                                  ...
                                  if($j==$posAtt && $dFromDate != $aFromDate) {
                                    $chk=1;  
                                    $tableData .= "<td width='5%' valign='top' class='padding_top' align='center'>".$notMemberPrefix."</td>";    
                                    $posAtt++;
                                    $dt=$dt+1;  
                                  }
                               }
...
//
//*****************  Version 10  *****************
//User: Parveen      Date: 4/12/10    Time: 12:30p
//Updated in $/LeapCC/Library/Teacher/TeacherActivity
...
//
//*****************  Version 8  *****************
//User: Parveen      Date: 4/12/10    Time: 11:23a
//Updated in $/LeapCC/Library/Teacher/TeacherActivity
//acces right updated
//
//*****************  Version 7  *****************
...
//Updated in $/LeapCC/Library/Teacher/TeacherActivity
//pervious attendance base code updated
//
//*****************  Version 6  *****************
