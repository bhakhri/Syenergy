...
//---------------------------------------------------------------------------------------------------------------
    ...
    */
    ...
    $searchStr=' AND c.classId='.$REQUEST_DATA['class'].' AND su.subjectId='.$REQUEST_DATA['subject'].' AND att.groupId='.$REQUEST_DATA['group'].' AND att.fromDate < "'.$REQUEST_DATA['startDate'].'"';
    $prevoiusRecordArray=$teacherManager->getStudentAttendanceTillDateNew($searchStr,' ',$orderBy);
