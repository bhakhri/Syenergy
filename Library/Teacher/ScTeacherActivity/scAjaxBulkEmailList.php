...
function trim_output($val){
 return (trim($val)!="" ? $val : "Not Present");   
    ...
    for($i=0;$i<$cnt;$i++) {
       ...
       'studentName' =>"<input type=\"checkbox\" name=\"students\" id=\"students\"  value=\"".$studentRecordArray[$i]['studentId'] ."\">".strip_slashes($studentRecordArray[$i]['studentName']),
...
// for VSS
// $History: scAjaxBulkEmailList.php $
//
//*****************  Version 1  *****************
