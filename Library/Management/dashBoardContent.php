...
<?php
    ...
    */
    ...
    $attCountArray = $managementManager->getManagementAttendanceThresholdRecords(" WHERE t.percentage < $attendaceThreshold");
    ...
    $teacherCountTestsArray = $managementManager->countManagementTeacherTests();
   ...
   */
	...
	//$attCountArray = $managementManager->getManagementAttendanceThresholdRecords(" WHERE t.percentage < $belowAvg");
