...
//--------------------------------------------------------
    ...
    $timeTableLabelManager = LeaveSetManager::getInstance();
    ...
    if(UtilityManager::notEmpty($REQUEST_DATA['searchbox'])) { 
       $filter = ' AND (ttl.leaveSetName LIKE "'.add_slashes(trim($REQUEST_DATA['searchbox'])).'%")';
    }
    
     ////////////   
    $totalArray = $timeTableLabelManager->getTotalLeaveSet($filter);
    $timeTableLabelRecordArray = $timeTableLabelManager->getLeaveSetList($filter,$limit);
