...
//--------------------------------------------------------
    ...
    $totalArray = $parentManager->getTotalNotices();
    $parentRecordArray = $parentManager->getNoticesList($filter,$limit);   
    
?>

<?php 

//$History: initDisplayNotices.php $
//
//*****************  Version 2  *****************
//User: Parveen      Date: 3/09/09    Time: 4:51p
