<?php
//-------------------------------------------------------
// THIS FILE IS USED TO ADD A role
//
//
...
UtilityManager::headerNoCache();
    ...
    if (trim($errorMessage) == '') {
        ...
        $foundArray = UserRoleManager::getInstance()->getRole(' WHERE UCASE(roleName)="'.add_slashes(strtoupper($REQUEST_DATA['roleName'])).'"');
        if(trim($foundArray[0]['roleName'])=='') {  //DUPLICATE CHECK
            $returnStatus = UserRoleManager::getInstance()->addRole();
