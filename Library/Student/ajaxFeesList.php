...
//--------------------------------------------------------
    ...
    $start = (($REQUEST_DATA['startingRecord'])-1);
    $end = $REQUEST_DATA['totalRecords'];
    ...
    for($i=0;$i<$cnt;$i++) { 
        ...
        if($studentRecordArray[$i]['receiptStatus']==3) {
            ...
            $printAction = "<a href='javascript:void(0)' onClick='printDetailReceipt(".$studentRecordArray[$i]['feeReceiptId'].",".$studentRecordArray[$i]['feeType'].")' title='Print'>
                        <img src=".IMG_HTTP_PATH."/print1.gif border='0' alt='Detail Print' title='Detail Print' hspace='4'></a>&nbsp;|&nbsp;
                        <a href='javascript:void(0)' onClick='printReceipt(".$studentRecordArray[$i]['feeReceiptId'].",".$studentRecordArray[$i]['feeType'].")' title='Print'>
                        <img src=".IMG_HTTP_PATH."/print1.gif border='0' alt='Receipt Print' title='Receipt Print' hspace='4'></a>&nbsp;|&nbsp;
                        <a name='Delete' onclick='deleteReceipt(\"".$feeReceiptId."\");return false;' title='Delete'><img src='".IMG_HTTP_PATH."/delete.gif' border='0' alt='Delete' title='Delete'></a>";
                        //<a href='javascript:void(0)' onClick='deleteReceipt(".$studentRecordArray[$i]['feeReceiptId'].",".$studentRecordArray[$i]['feeType'].")' title='Delete'>
                        //<img src=".IMG_HTTP_PATH."/delete.gif border='0' alt='Delete Receipt' title='Delete Receipt' hspace='4'></a>";
