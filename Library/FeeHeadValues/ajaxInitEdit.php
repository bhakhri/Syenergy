...
//  This File calls Edit Function used in adding "FEE HEAD VALUES" Records
//
//
...
UtilityManager::headerNoCache(); 
    ...
    $condition .= ' AND feeHeadValueId!='.$REQUEST_DATA['feeHeadValueId'];
    ...
    if (trim($errorMessage) == '') {
     ...
     if(trim($foundArray[0]['feeHeadId'])=='') { 
        $returnStatus = FeeHeadValuesManager::getInstance()->editFeeHeadValues($REQUEST_DATA['feeHeadValueId']);            
