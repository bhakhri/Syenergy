     ...
     // =========== Fetch Student Fee Head Wise Detail (START) ==============================
         ...
         if($feeTypeId == '4' || $feeTypeId == '1') {           // Only Academic
            ...
            for($i=0; $i<count($foundArray); $i++) {
               ...
               $applAmt="<input type='text'   name='applAmt[]'    id='applAmt$i'     value='$ttApplTotal'  maxlength='14' style='width:70px' class='inputbox2'>
         ...
         if($transportFacility==1 && ($feeTypeId == '4' || $feeTypeId == '2')) {    // Only Transport
               ...
               $applAmt="<input type='text' name='applAmtTransportPaid' id='applAmtTransportPaid' value='".$ttApplTotal."' maxlength='10' style='width:70px' class='inputbox2'>
         ...
         if($hostelFacility==1 && ($feeTypeId == '4' || $feeTypeId == '3')) {   // Only Hostel
               ...
               $applAmt="<input type='text' name='applAmtHostelPaid' id='applAmtHostelPaid' value='".$ttApplTotal."' maxlength='10' style='width:70px' class='inputbox2'>
         ...
         for($i=0; $i<count($foundArray); $i++) {
               ...
               $feeHeadId = $foundArray[$i]['feeHeadId'];
               $feeMiscHeadId = $foundArray[$i]['feeHeadId']."~M";
               if($feeHeadId=='') {  
                 continue;   
               }
               
               $srNo=$rSrNo;  
               $headName= "<span style='color:blue;font-size:11px;'>".$foundArray[$i]['headName']."</span>";
            $feeHeadAmt  ="<input type='text' onchange='calculateConcession();' id='studentMisc$feeHeadId' name='studentMisc[]' maxlength=8 style='width:70px' class='inputbox2'>";
               $applFeeHead ="<input type='text' name='studentMiscApplAmt[]' id='studentMiscApplAmt$feeHeadId' style='width:70px' class='inputbox2'>
            <input type='hidden' readonly='readonly'  name='miscFeeHeadIds[]' id='miscFeeHeadIds$rSrNo'  value='$feeMiscHeadId'  class='inputbox2' >";
