<?php
//-------------------------------------------------------
// THIS FILE IS USED TO ADD A slab
//
//
...
UtilityManager::headerNoCache();
    ...
    if (trim($errorMessage) == '') {
        ...
        $foundArray = SlabsManager::getInstance()->checkSlabs($REQUEST_DATA['deliveredFrom'],$REQUEST_DATA['deliveredTo']);
        if(trim($foundArray[0]['deliveredFrom'])=='') {  //DUPLICATE CHECK
            $returnStatus = SlabsManager::getInstance()->addSlabs();
