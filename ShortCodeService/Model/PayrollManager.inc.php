...
//-------------------------------------------------------------------------------         
     public function clearSalaryGenerated($empId,$month,$year) {
        ...
        salary_generated_history where employeeId=$empId and month='$month' and year='$year' and status=0) and MONTHNAME(withEffectFrom)='$month' and
