...
var tableHeadArray = new Array(
     ...
     new Array('universityRollNo','Univ. RNo.','width="10%"','',true),
     //new Array('totalFees','T.Fees','width="4%"','align="right"',false),
     new Array('feeHeadAmount','Head Value','width="6%"','align="right" nowrap',false),
     new Array('totalConce','Concession','width="8%"','align="right"',false),
     new Array('concessionType','Type','width="12%" valign="middle"','valign="middle"',false),
     new Array('concessionValue','Value','width="5%" valign="middle"','valign="middle"',false),
     new Array('discValue','Balance','width="6%" valign="middle"','valign="middle"',false),
     new Array('reason','Reason','width="10%" valign="middle"','valign="middle"',false) 
...
listURL = '<?php echo HTTP_LIB_PATH;?>/StudentConcession/ajaxStudentFeeConcessionList.php';
...
function validateForm() {
  ...
  */
  ...
  //alert(document.getElementById('feeHead').value);
  if(document.getElementById('feeHead').value==''){
        messageBox("<?php echo SELECT_FEEHEAD;?>");
        document.getElementById('feeHead').focus();
        return false;
  ...
  for(var i=0;i<len;i++){
     ...
     studentString +=scl+'_'+type+'_'+value+'_'+trim(discValue.value)+'_'+trim(maxValue)+'!_$^!@^@'+trim(reason.value);
	 //alert(studentString);
	 //return false;
   }
  }
   
   var url = '<?php echo HTTP_LIB_PATH;?>/StudentConcession/ajaxCheckConcession.php';
   new Ajax.Request(url,
       {
         ...
         parameters: {
             ...
             leet : document.getElementById('leet').value, 
