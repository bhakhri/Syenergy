...
<title><?php echo SITE_NAME;?>: Transport Staff Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/TransportStaff/transportStaffPrint.php");
?>
</body>
</html>
<?php 
// $History: transportStaffReportPrint.php $
//
//*****************  Version 2  *****************
