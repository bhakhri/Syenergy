...
<title><?php echo SITE_NAME;?>: Grade Transcript Report </title>
<?php 
require_once(TEMPLATES_PATH .'/jsCssHeader.php'); 
?> 
<script language="javascript">
var listURL='<?php echo HTTP_LIB_PATH;?>/StudentReports/initGradeTranscriptReport.php';
...
function validateAddForm() {
   ...
   var url='<?php echo HTTP_LIB_PATH;?>/StudentReports/initGradeTranscriptReport.php';   
   page=1;
...
function printReport() {
   ...
   query = '&headerChk='+hd+'&branchChk='+bc+'&studentId='+studentCheck+'&allSemester='+allSemester+'&semester='+semesterCheck+'&authorized='+authorized;
   query = query+'&designation='+designation+'&gpaChk='+gpaChk+'&cgpaChk='+cgpaChk;
...
function printReportCSV() {
    ...
    path='<?php echo UI_HTTP_PATH;?>/gradeTranscriptCSV.php'+queryString;
    window.location=path; 
}
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/StudentReports/listGradeTranscriptReportContents.php");
