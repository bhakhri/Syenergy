...
<title><?php echo SITE_NAME;?>: Class Wise Concession Head Mapping</title>
<?php 
...
function validateAddForm(frm) {
    ...
    if(resourceAddCnt==0) {
        ...
        msg = confirm('All Class Wise Head Value will be deleted. Are you sure?')
        if(msg == false) {
            return false;
        }
    }
...
*/
   ...
   new Ajax.Request(url,
   {
     ...
     onSuccess: function(transport){
        hideWaitDialog(true);    
        if(trim("<?php echo CLASS_WISE_HEAD_VALUE_ADDED_SUCCESSFULLY;?>") == trim(transport.responseText) || trim("<?php echo CLASS_WISE_HEAD_DELETE_SUCCESSFULLY;?>") == trim(transport.responseText) || trim("<?php echo CLASS_WISE_HEAD_VALUE_UPDATED_SUCCESSFULLY;?>") == trim(transport.responseText)) {
