...
define('MODULE','CreateTimeTableClassWiseDayWise');
define('ACCESS','edit');
...
<title><?php echo SITE_NAME;?>: Manage Class and Day Wise (Weekly) Time Table</title>
<?php
...
function getCurrentTimeTable() {
	...
	pars = 'classId='+form.studentClass.value+'&labelId='+form.timeTableLabelId.value+'&day='+form.day.value+'&periodSlotId='+form.periodSlotId.value;
    new Ajax.Request(url,
    {
         method:'post',
         parameters: pars,
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/TimeTable/timetableClassWiseDayWiseContents.php");
    require_once(TEMPLATES_PATH . "/footer.php");
    ?>
</body>
</html>
<?php
// $History: createTimeTableClassWiseDayWise.php $
//
//*****************  Version 7  *****************
...
//
//*****************  Version 2  *****************
//User: Ajinder      Date: 10/03/09   Time: 9:57a
//Updated in $/LeapCC/Interface
//changed sending dayId parameter to day.
//
//*****************  Version 1  *****************
