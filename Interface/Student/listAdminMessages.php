...
//require_once(BL_PATH . "/Student/initAdminMessages.php");
?>
...
listURL = '<?php echo HTTP_LIB_PATH;?>/Student/ajaxDisplayAdminMessages.php';
		 ...
		 new Ajax.Request(url,
		   {      
			 ...
			 onSuccess: function(transport){
				  ...
				  document.getElementById("innerNotice").innerHTML = j.message;
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/Student/adminMessagesContents.php");
