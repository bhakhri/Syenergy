...
<title><?php echo SITE_NAME;?>: Vehicle Detail Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Vehicle/vehicleDetailPrint.php");
?>
</body>
</html>
<?php 
// $History: vehicleDetailReportPrint.php $
//
//*****************  Version 1  *****************
