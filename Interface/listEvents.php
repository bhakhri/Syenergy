...
<title><?php echo SITE_NAME;?>: Event Master </title>
<?php
...
var tableHeadArray = new Array(new Array('srNo','#','width="3%"','',false),
                               ...
                               new Array('eventWishDate','Event Date','width="15%"','align="center"',true),
                               new Array('abbr','Abbrevation','width="15%"','align="left"',true), 
                               new Array('comments','Comments','width="45%"','',true),
                               new Array('checkAll','Visible <input type="checkbox" name="checkbox2" id="checkbox2" value="checkbox" onClick="doAll()">','width="12%" align="center"','align="center"',false),
...
function validateAddForm(frm, act) {
    ...
    if(act=='Add') {
        if(document.addEvent.elm11.value =='') {
          messageBox("Enter Comments");
          document.addEvent.elm11.focus();
          return false;
        }
        if(document.addEvent.eventAbbrevation.value =='') {
          messageBox("Enter Abbrevation");
		...
		if(document.editEvent.elm12.value =='') {
          messageBox("Enter Comments");
          document.editEvent.elm12.focus();
          return false;
        }
        if(document.editEvent.eventAbbrevation.value =='') {
          messageBox("Enter Abbrevation");
			   ...
			   /*
                  ...
                  if(j[0].eventPhoto=='' || j[0].eventPhoto==null){
                     ...
                     document.getElementById('editLogoPlace').style.display = 'none';
                      ...
                      //document.getElementById('editLogoPlace').innerHTML = j.eventPicture;
                      //document.getElementById('downloadFileName').value = j.eventPicture;
                      document.getElementById('editLogoPlace').style.display = '';
                  }
                  document.getElementById('uploadIconLabel').innerHTML='';
                  if(j.eventPhoto !=-1){
                      document.getElementById('uploadIconLabel').innerHTML='<img src="<?php echo IMG_HTTP_PATH; ?>/delete.gif"  onclick="deatach('+j.userWishEventId+');" title="Delete Uploaded File" />';
                  } 
               */
               document.editEvent.elm12.focus();
         },
...
function  download1(){
   ...
   var address="<?php echo IMG_HTTP_PATH;?>/Event/"+document.getElementById('downloadFileName').value;
...
function  download(str){
    var address="<?php echo IMG_HTTP_PATH;?>/Event/"+str;
	//alert(address);
    window.open(address,"Attachment","status=1,resizable=1,width=800,height=600")
}
