...
<title><?php echo SITE_NAME;?>: Test Type Category wise Detailed Report Print </title>
<?php 
...
<?php 
    ...
    require_once(TEMPLATES_PATH . "/StudentReports/listTestWiseMarksConsolidatedReportPrint.php");
    //require_once(TEMPLATES_PATH . "/footer.php");
?>
</body>
</html>
<?php 
////$History: testWiseMarksConsolidatedReportPrint.php $
//
//*****************  Version 2  *****************
