...
function showReport() {
  ...
  var url = '<?php echo HTTP_LIB_PATH;?>/FeedbackAdvanced/ajaxGetTeacherGpaReport.php';
         new Ajax.Request(url,
           {
             method:'post',
             parameters: {
...
function printReport() {
   ...
   var path='<?php echo UI_HTTP_PATH;?>/teacherGpaPrint.php?'+qstr;
...
function printCSV() {
   ...
   window.location='teacherGpaReportCSV.php?'+qstr;
}
...
<body>
	...
	require_once(TEMPLATES_PATH . "/FeedbackAdvanced/listFeedbackTeacherGpaContents.php");
    require_once(TEMPLATES_PATH . "/footer.php");
    ?>
</body>
</html>
<?php                              
// $History: listFeedbackTeacherGpaReport.php $ 
//
//*****************  Version 1  *****************
