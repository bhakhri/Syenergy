<?php
//-------------------------------------------------------
//  This File is used for Management role permission
//
//
...
define('MODULE','ManagementRolePermissions');
define('ACCESS','view');
...
<title><?php echo SITE_NAME;?>: Management Role Permissions </title>
<?php 
...
*/
   uncheckAll();
   form = document.listForm;
   url = '<?php echo HTTP_LIB_PATH;?>/RolePermission/ajaxManagementGetRolePermissions.php';
...
function savePermissions() {
   ...
   url = '<?php echo HTTP_LIB_PATH;?>/RolePermission/ajaxManagementSaveRolePermissions.php';
    new Ajax.Request(url,
    {
	     method:'post',
...
<body>
	...
	require_once(TEMPLATES_PATH . "/RolePermission/listManagementRolePermission.php");
    require_once(TEMPLATES_PATH . "/footer.php");
    ?>
</body>
</html>
<?php 
// $History: managementPermission.php $
//
//*****************  Version 1  *****************
