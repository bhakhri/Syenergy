...
<title><?php echo SITE_NAME;?>: Student Admit Card </title>
<style>
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/StudentReports/studentAdmitCard.php");
...
<?php
  //$History: listStudentAdmitCard.php $
//
//*****************  Version 1  *****************
...
//
//*****************  Version 2  *****************
//User: Jaineesh     Date: 7/10/08    Time: 5:14p
//Updated in $/Leap/Source/Interface
