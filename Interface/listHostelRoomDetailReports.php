...
<title><?php echo SITE_NAME;?>: Hostel Room Detail Report </title>
<?php 
...
function validateAddForm(frm) {
    ...
    var url='<?php echo HTTP_LIB_PATH;?>/HostelDetailReports/initHostelDetailReportsList.php';  
    /*
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/HostelDetailReports/listHostelDetailReportsContents.php");
