<?php
//---------------------------------------------------------------------------
//  THIS FILE used for quarantine students
//
...
<title><?php echo SITE_NAME;?>: Delete Students</title>
<?php 
...
listURL = '<?php echo HTTP_LIB_PATH;?>/QuarantineStudent/ajaxStudentList.php';
...
if((document.listFrm.students.length - 2) == 0){
   ...
   return false;
     ...
     alert("<?php echo QUARANTINE_STUDENT_SELECT_ALERT; ?>");      
     document.getElementById('studentList').focus();
     return false;
  } 
else{
     if(!confirm("Groups assigned to selected student(s) will be deleted as well.\nAre you sure?")){
         return false;
     }
     quarantineStudents(); //sends the message
     return false;
  }  
}
...
//
//--------------------------------------------------------
function quarantineStudents() {
         var url = '<?php echo HTTP_LIB_PATH;?>/QuarantineStudent/ajaxQuarantineStudent.php';
         /*
         ...
         new Ajax.Request(url,
           {
             ...
             onSuccess: function(transport){
                     ...
                     if("<?php echo SUCCESS;?>" == trim(transport.responseText)) {                     
                         flag = true;
                       messageBox("<?php echo QUARANTINE_OK; ?>");     
                     } 
                     else {
...
function resetForm(){
 ...
 /* function to print Delete Student report*/
function printReport() { 
    ...
    var path='<?php echo UI_HTTP_PATH;?>/deleteStudentReportPrint.php?'+qstr;
    window.open(path,"DeleteStudentReport","status=1,menubar=1,scrollbars=1, width=900, height=700, top=100,left=50");
}
...
function printCSV() {
    ...
    window.location='deleteStudentReportCSV.php?'+qstr;
} 
...
<body>
	...
	require_once(TEMPLATES_PATH . "/QuarantineStudent/listQuarantineStudentContents.php");
...
<?php                              
// $History: listQuarantineStudent.php $ 
//
//*****************  Version 7  *****************
...
//
//*****************  Version 3  *****************
//User: Dipanjan     Date: 11/06/08   Time: 5:46p
//Updated in $/Leap/Source/Interface
//Removed "management access" from module
//
//*****************  Version 2  *****************
//User: Dipanjan     Date: 11/06/08   Time: 5:17p
//Updated in $/Leap/Source/Interface
//Added javascript restriction before delete 
?>