...
var tableHeadArray = new Array(
 ...
 new Array('actionString','Appraise','width="5%"','align="center"',true)
);

recordsPerPage = 5000;

linksPerPage = <?php echo LINKS_PER_PAGE;?>;
listURL = '<?php echo HTTP_LIB_PATH;?>/Appraisal/AppraisalData/employeeList.php';
...
function openAppraisal(val){
    if(val==''){
        messageBox("<?php echo EMPLOYEE_INFO_MISSING; ?>");
        return false;
    }
    var url = '<?php echo HTTP_LIB_PATH;?>/Appraisal/AppraisalData/setInfo.php';
    new Ajax.Request(url,
       {
         ...
         onSuccess: function(transport){
                ...
                if("<?php echo SUCCESS;?>"==trim(transport.responseText)) {
                    var path='<?php echo UI_HTTP_PATH;?>/appraisalForm.php?'+generateQueryString('employeeDetailsForm');;
...
<body>
	...
	require_once(TEMPLATES_PATH . "/Appraisal/AppraisalData/listEmployeeAppraisalContents.php");
