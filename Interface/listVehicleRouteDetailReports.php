...
<title><?php echo SITE_NAME;?>: Vehicle Route Detail Report</title>
<?php 
...
searchFormName = 'VehicleDetailForm'; // name of the form which will be used for search
...
function validateAddForm(frm) {
    ...
    var url='<?php echo HTTP_LIB_PATH;?>/VehicleDetailReports/initVehicleDetailReportsList.php';  
    /*
    var fieldsArray = new Array(new Array("reportType","<?php echo SELECT_HOSTEL_ROOM_TYPE;?>"));
...
function printReport() {
	form = document.VehicleDetailForm;
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/VehicleDetailReports/listVehicleDetailReportsContents.php");
