<?php
//-------------------------------------------------------
//  This File is used for Student role permission
//
//
...
<title><?php echo SITE_NAME;?>: Student Role Permissions </title>
<?php 
...
*/
   uncheckAll();
   form = document.listForm;
   url = '<?php echo HTTP_LIB_PATH;?>/RolePermission/ajaxStudentGetRolePermissions.php';
...
function savePermissions() {
   ...
   url = '<?php echo HTTP_LIB_PATH;?>/RolePermission/ajaxStudentSaveRolePermissions.php';
    new Ajax.Request(url,
    {
	     method:'post',
...
<body>
	...
	require_once(TEMPLATES_PATH . "/RolePermission/listStudentRolePermission.php");
    require_once(TEMPLATES_PATH . "/footer.php");
    ?>
</body>
</html>
<?php 
// $History: studentPermission.php $
//
//*****************  Version 1  *****************
