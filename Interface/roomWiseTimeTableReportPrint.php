...
<title><?php echo SITE_NAME;?>: Room wise Time Table Print </title>
<?php 
...
<?php 
    ...
    require_once(TEMPLATES_PATH . "/TimeTable/roomWiseTimeTablePrint.php");
?>
</body>
</html>
<?php 
// $History: roomWiseTimeTableReportPrint.php $
//
//*****************  Version 2  *****************
