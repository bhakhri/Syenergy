...
<title><?php echo SITE_NAME;?>: Restore Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/RestoreStudent/restoreStudentPrint.php");
?>
</body>
</html>
<?php 
// $History: restoreStudentReportPrint.php $
//
//*****************  Version 1  *****************
