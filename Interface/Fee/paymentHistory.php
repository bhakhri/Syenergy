...
var tableHeadArray =  new Array(new Array('srNos','#','width="2%"','',false),
                               ...
                               new Array('className', 'Fee Class','width="12%"','',true),  
                               new Array('cycleName','Fee Cycle','width="8%"','',true),  
                               new Array('installmentNo','Installment','width="10%"','',true),
                               new Array('feeTypeOf','Pay Fee Of','width="10%"','',true),
                               new Array('employeeCodeName','Collected By','width="8%"','align="center"',false),   
                               new Array('receiveCash', 'Cash(Rs.)','width="8%"','align="right"',true), 
                               new Array('receiveDD', 'DD(Rs.)','width="8%"','align="right"',true), 
...
listURL = '<?php echo HTTP_LIB_PATH;?>/Fee/PaymentHistory/ajaxFeeList.php';
...
function printReport() {
    ...
    path='<?php echo UI_HTTP_PATH;?>/Fee/paymentHistoryReportPrint.php?'+qstr;
...
function printCSV() {
	...
	var params = generateQueryString('allDetailsForm');
    var qstr=params+"&sortOrderBy="+sortOrderBy+"&sortField="+sortField;
	path='<?php echo UI_HTTP_PATH;?>/Fee/paymentHistoryReportCSV.php?'+qstr; 
...
function tallyXMlData() {    
    
   var url='<?php echo HTTP_LIB_PATH;?>/TallyXml/ajaxFeeList.php';
   ...
   new Ajax.Request(url,
   {
      ...
      onSuccess: function(transport){
         ...
         if(trim(transport.responseText)==false) {
         ...
         else if("<?php echo 'Data not found';?>" == trim(transport.responseText)) {
            ...
            window.location.href = "<?php echo HTTP_LIB_PATH;?>/download.php?t=tallyXml+&x="+x;  
         }
      },
...
<?php 
    ...
    require_once(TEMPLATES_PATH . "/Fee/PaymentHistory/paymentHistoryContents.php");
