...
<title><?php echo SITE_NAME;?>: Feedback College GPA Report (Advanced) Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/FeedbackAdvanced/collegeGpaPrint.php");
?>
</body>
</html>
<?php 
// $History: collegeGpaPrint.php $
//
//*****************  Version 1  *****************
