...
var tableHeadArray = new Array(new Array('srNo','#','width="3%"','',false), 
                               new Array('countryName','Country Name','width="35%"','',true) , 
                               new Array('countryCode','Country Code','width="30%"','',true), 
                               new Array('nationalityName','Nationality ','width="25%"','',true), 
                               new Array('action','Action','width="7%"','align="center"',false));

recordsPerPage = <?php echo RECORDS_PER_PAGE;?>;
linksPerPage = <?php echo LINKS_PER_PAGE;?>;
listURL = '<?php echo HTTP_LIB_PATH;?>/Country/ajaxInitList.php';
