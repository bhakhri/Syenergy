...
<title><?php echo SITE_NAME;?>: Fuel Consumable Time Period Report</title>
<?php
...
function getData() {
         ...
         url = '<?php echo HTTP_LIB_PATH;?>/Fuel/ajaxGetTimePeriodFuelConsumable.php';
         var tableColumns = new Array (
											new Array('srNo','#','width="1%" align="left"',false),
											new Array('fuelMonth','Month/Year','width="1%" align="left"',false),
        ...
        listObj = new initPage(url,recordsPerPage,linksPerPage,1,'','busNo','ASC','resultsDiv','','',true,'listObj',tableColumns,'','','&busId='+document.getElementById('vehicleNo').value+'&fromDate='+document.getElementById('fromDate').value+'&toDate='+document.getElementById('toDate').value+'&reportType='+document.getElementById('reportType').value);
...
<body>
	...
	require_once(TEMPLATES_PATH . "/Fuel/fuelConsumableTimePeriodReport.php");
