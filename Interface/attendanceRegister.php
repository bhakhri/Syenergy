...
function refreshAttendanceRegisterData1() {
     ...
     //url='<?php echo HTTP_LIB_PATH;?>/AdminTasks/ajaxStudentList.php';        
     url='<?php echo HTTP_LIB_PATH;?>/AdminTasks/ajaxAttendanceRegisterList.php';        
     hideResults();
     page=1;
     queryString = '';
     ...
     medicalLeave =0;
     if(document.attendanceForm.medicalLeave.checked) {
       medicalLeave =1;
     }
     else {
       medicalLeave =0;  
     ...
     queryString = 'dutyLeave='+dutyLeave+'&medicalLeave='+medicalLeave+'&timeTable='+timeTable+'&fromDate='+form.fromDate.value+'&degree='+form.degree.value;  
     queryString = queryString+'&subjectId='+form.subjectId.value+'&groupId='+form.groupId.value+'&nosCol='+form.nosCol.value; 
     queryString = queryString+'&notMemberPrefix='+form.notMemberPrefix.value+'&absentPrefix='+form.absentPrefix.value+'&dutyLeavePrefix='+form.dutyLeavePrefix.value+'&medicalLeavePrefix='+form.medicalLeavePrefix.value; 
     queryString = queryString+'&sortOrderBy='+sortOrderBy+'&sortField='+form.sortField1.value+'&page='+page+'&consolidatedId='+consolidatedId;
...
function validateAddForm(frm) {
    ...
    */
    ...
    if(parseInt(document.getElementById('nosCol').value,10) == 0) {
       messageBox("<?php echo "Attendance doesn't exist"; ?>");
       document.getElementById('nosCol').focus();
       return false;  
    }
  ...
  /*if(trim(document.getElementById('notMemberPrefix').value)=='') {
       messageBox("<?php echo "Enter the value of Not Member of Class Prefix"; ?>");   
       document.getElementById('notMemberPrefix').focus();
       return false;  
    }
    if(trim(document.getElementById('absentPrefix').value)=='') {
       messageBox("<?php echo "Enter the value of Absent Prefix"; ?>");   
       document.getElementById('absentPrefix').focus();
       return false;  
    }
    if(trim(document.getElementById('dutyLevePrefix').value)=='') {
       messageBox("<?php echo "Enter the value of Duty Leave Prefix"; ?>");   
       document.getElementById('dutyLevePrefix').focus();
       return false;  
    }
  */  
...
function printReport() {
    ...
    path='<?php echo UI_HTTP_PATH;?>/attendanceRegisterPrint.php?'+queryString+'&heading='+escape(trim(form.heading.value)); 
...
function printCSV() {
    ...
    path='<?php echo UI_HTTP_PATH;?>/attendanceRegisterCSV.php?'+queryString+'&heading='+escape(trim(form.heading.value)); 
...
function getLabelClass(){
     ...
     var pars = 'labelId='+rval[0];     
     
     if(rval[2]!='0000-00-00' && rval[2]!='') {
       document.getElementById('fromDate').value=rval[2];
     }
     //if(rval[2]!='0000-00-00' && rval[2]!='') {
...
function getSubject(){
    ...
    document.getElementById('deliverAttendance').innerHTML="<?php echo NOT_APPLICABLE_STRING; ?>";
    var url = '<?php echo HTTP_LIB_PATH;?>/AdminTasks/ajaxGetTimeTableSubjects.php';
...
function getGroup(){
    ...
    var url = '<?php echo HTTP_LIB_PATH;?>/AdminTasks/ajaxGetTimeTableGroups.php';
...
function getDeliverLecture(){
    ...
    var url = '<?php echo HTTP_LIB_PATH;?>/AdminTasks/ajaxGetDeliverAttendance.php';
   ...
   */ 
    ...
    pars = 'timeTableLabelId='+rval[0]+'&classId='+degree+'&subjectId='+subject+'&groupId='+group+'&fromDate='+fromDate+'&consolidatedId='+consolidatedId;
...
function sendKeys(eleName, e) {
  ...
  if (thisKeyCode == '13') {
    ...
    <body>
        ...
        require_once(TEMPLATES_PATH . "/AdminTasks/attendanceRegisterContent.php");
