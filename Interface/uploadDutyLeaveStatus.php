...
<title><?php echo SITE_NAME;?>: Duty Leave Uploaded Student Status CSV</title>
</head>
<body>
<?php 
...
$studentStatusString=trim($sessionHandler->getSessionVariable('DutyLeave_UploadStudentDetails'));
