...
<title><?php echo SITE_NAME;?>: Student Consolidated Print </title>
<?php 
...
<?php 
    ...
    require_once(TEMPLATES_PATH . "/StudentReports/studentConsolidatedPrintNew.php");
?>
</body>
</html>
<?php 
// $History: studentConsolidatedReportPrint.php $
//
//*****************  Version 2  *****************
