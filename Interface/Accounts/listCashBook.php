<?php
//-------------------------------------------------------
//  This File contains intial code for cash book
//
//
...
<title><?php echo SITE_NAME;?>: Cash Book </title>
<?php 
...
searchFormName = 'cashBookForm'; // name of the form which will be used for search
...
function printReport() {
	form = document.cashBookForm;
	path='<?php echo UI_HTTP_ACCOUNTS_PATH;?>/cashBookReportPrint.php?tillDate='+form.tillDate.value;
	window.open(path,"MissedAttendanceReport","status=1,menubar=1,scrollbars=1, width=900");
}


function showCashBook(tillDate) {
	var url = '<?php echo HTTP_LIB_PATH;?>/Accounts/CashBook/initCashBook.php';
	frm = document.cashBookForm;
	var pars = generateQueryString('cashBookForm');
...
window.onload = function() {
	...
	if (typeof tillDate != 'undefined') {
		validateAddForm(document.cashBookForm, tillDate)
	}
}
...
<?php 
	...
	require_once(TEMPLATES_PATH . "/Accounts/CashBook/listCashBookReport.php");
