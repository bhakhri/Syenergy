<?php
//-------------------------------------------------------
//  This File contains logic for group summary display
//
//
...
function printReport() {
	...
	path='<?php echo UI_HTTP_ACCOUNTS_PATH;?>/groupSummaryReportPrint.php?tillDate='+form.tillDate.value+'&groupId='+form.groupId.value;
...
function showGroupSummary(tillDate, groupId) {
	...
	var pars = 'tillDate='+tillDate+'&groupId='+groupId+'&from=groupSummaryDisplay';
...
<body>
   ...
   echo '<script type="text/javascript">currentThemeId = "'.$sessionHandler->getSessionVariable('UserThemeId').'";</script>'; 
    require_once(TEMPLATES_PATH . "/Accounts/Groups/listGroupSummaryDisplayContents.php");
	echo '<script language="javascript">changeColor(currentThemeId);</script>';
    ?>
</body>
</html>
<?php 
// $History: listGroupSummaryDisplay.php $
//
//*****************  Version 1  *****************
