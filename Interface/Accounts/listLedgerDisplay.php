...
function printReport() {
	...
	path='<?php echo UI_HTTP_ACCOUNTS_PATH;?>/listLedgerReportPrint.php?ledgerId='+form.ledgerId.value+'&tillDate='+form.tillDate.value;
