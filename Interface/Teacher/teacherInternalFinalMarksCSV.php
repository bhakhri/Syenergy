...
<title><?php echo SITE_NAME;?>: Display Student Final Marks CSV</title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Teacher/TeacherActivity/teacherFinalMarksCSV.php");
?>
</body>
</html>
<?php 
// $History: teacherInternalFinalMarksCSV.php $
//
//*****************  Version 2  *****************
