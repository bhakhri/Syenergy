...
<title><?php echo SITE_NAME;?>: Group Wise Performance Detail Report </title>
<?php
...
<body>
<?php
    require_once(TEMPLATES_PATH . "/Teacher/TeacherActivity/groupWisePerformanceDetailPrint.php");
?>
</body>
</html>
<?php
//$History: groupWisePeformanceDetailPrint.php $
//
//*****************  Version 1  *****************
