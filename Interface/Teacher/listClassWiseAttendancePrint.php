...
<title><?php echo SITE_NAME;?>: Display Attendance Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Teacher/TeacherActivity/listClassAttendancePrint.php");
?>
</body>
</html>
<?php 
// $History: listClassWiseAttendancePrint.php $
//
//*****************  Version 2  *****************
