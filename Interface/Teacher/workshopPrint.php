...
<title><?php echo SITE_NAME;?>: Workshop Report Print</title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Teacher/TeacherActivity/workshopReportPrint.php");
?>
</body>
</html>
<?php 
// $History: workshopPrint.php $
//
//*****************  Version 3  *****************
