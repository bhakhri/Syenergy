...
<title><?php echo SITE_NAME;?>: Duty Leaves Entry </title>
<?php 
...
function getStudentList(){
  var url = '<?php echo HTTP_LIB_PATH;?>/Teacher/TeacherActivity/ajaxStudentDutyLeaveList.php';
...
function giveDutyLeaves(dates,leaves,comments){
  var url = '<?php echo HTTP_LIB_PATH;?>/Teacher/TeacherActivity/doStudentDutyLeave.php';
         new Ajax.Request(url,
           {
             method:'post',
             parameters: {
...
function populateValues(studentId,classId,groupId,subjectId) {
         url = '<?php echo HTTP_LIB_PATH;?>/Teacher/TeacherActivity/getStudentDutyLeaveDetails.php';
         new Ajax.Request(url,
           {
             method:'post',
             parameters: {
...
<?php 
	...
	require_once(TEMPLATES_PATH . "/Teacher/TeacherActivity/dutyLeaveEntryContents.php");
