...
define('MODULE','SendMessageParentMailBox');
define('ACCESS','view');
UtilityManager::ifTeacherNotLoggedIn();  
//require_once(BL_PATH . "/AdminMessage/scInitData.php");
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title><?php echo SITE_NAME;?>: Send Message to Parents Mail Box</title>
...
function refreshInboxData(){
  ...
  url = '<?php echo HTTP_LIB_PATH;?>/AdminMessage/ajaxInitParentMessageList.php';
  ...
  var tableColumns = new Array(
                        ...
                        new Array('parentName','From','width="10%" align="left"',true),
                        new Array('studentName','Student','width="10%" align="left"',true), 
                        new Array('messageDate','Date','width="10%" align="center"',true),
                        new Array('message','Message','width="27%" align="left"',true),
...
function refreshSentItemData(){
  ...
  url = '<?php echo HTTP_LIB_PATH;?>/AdminMessage/ajaxInitSentItemList.php';
  var tableColumns = new Array(
                        new Array('srNo','#','width="2%" align="left"',false), 
                        new Array('messageSubject','Subject','width="17%" align="left"',true),  
                        new Array('employeeName','From','width="10%" align="left"',true),                
                        new Array('parentName','To','width="10%" align="left"',true),
                        new Array('studentName','Student','width="10%" align="left"',true),  
                        new Array('messageDate','Date','width="10%" align="center"',true),
...
function validateAddForm(frm, act) {
    ...
    var formx = document.ParentTeacher;
    mailCheck='';
       ...
       for(var i=1;i<formx.length;i++){
         if(formx.elements[i].type=="checkbox"){
            if((formx.elements[i].checked)){
                if(mailCheck=='') {
                   mailCheck=formx.elements[i].value; 
                }
                else {
                    mailCheck += ',' +formx.elements[i].value; 
                }
...
function initAdd(mode) {
    ...
    if(mode==1){
        ...
        document.getElementById('ParentTeacher').action= "<?php echo HTTP_LIB_PATH;?>/AdminMessage/messageFileUpload.php"
...
function addParentTeacher() {
    globalFL=0;
     var url = '<?php echo HTTP_LIB_PATH;?>/AdminMessage/ajaxInitParentTeacherAdd.php';
     new Ajax.Request(url,
       {
         method:'post',
         parameters: {
             rollNo: trim(document.ParentTeacher.rollNo.value),
             chb: mailCheck,
...
function blankValues() {
   document.getElementById('divHeaderId1').innerHTML='&nbsp; Send Message to Teacher';
  ...
  // document.ParentTeacher.teacherId.value = '';
   ...
   document.ParentTeacher.rollNo.disabled = false;
...
function deleteParentTeacher(id) {
     ...
     url = '<?php echo HTTP_LIB_PATH;?>/AdminMessage/ajaxInitAdminDelete.php';
     new Ajax.Request(url,
       {
         method:'post',
...
function editParentTeacher() {
     globalFL=0;
     var url = '<?php echo HTTP_LIB_PATH;?>/AdminMessage/ajaxInitStudentTeacherEdit.php';
...
function populateValues(id) {
     ...
     url = '<?php echo HTTP_LIB_PATH;?>/AdminMessage/ajaxGetStudentTeacherValues1.php';
     new Ajax.Request(url,
       {
         method:'post',
         parameters: {messageId: id},
         ...
         onSuccess: function(transport){
               ...
               document.getElementById('receiverName').innerHTML = trim(j.parentName)+'<br>'+trim(j.studentName);
...
function populateValues1(id) {
     ...
     url = '<?php echo HTTP_LIB_PATH;?>/AdminMessage/ajaxGetParentTeacherValues.php';
     new Ajax.Request(url,
       {
         method:'post',
         parameters: {messageId: id},
...
function populateSentData(id) {
     ...
     url = '<?php echo HTTP_LIB_PATH;?>/AdminMessage/ajaxGetStudentTeacherValues.php';
     new Ajax.Request(url,
     {
         method:'post',
         parameters: {messageId: id},
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/Teacher/TeacherActivity/parentMessageContents.php");
