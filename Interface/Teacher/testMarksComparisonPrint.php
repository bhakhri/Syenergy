...
<title><?php echo SITE_NAME;?>: Test Wise Performance Comaparison Report </title>
<?php
...
<body>
<?php
    require_once(TEMPLATES_PATH . "/Teacher/TeacherActivity/testMarksComparisonPrint.php");
?>
</body>
</html>
<?php
