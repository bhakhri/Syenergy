...
<title><?php echo SITE_NAME;?>: Feedback Teacher Final Report (Advanced) Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/FeedbackAdvanced/Teacher/teacherFinalReportPrint.php");
?>
</body>
</html>
<?php 
