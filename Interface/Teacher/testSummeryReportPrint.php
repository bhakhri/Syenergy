...
<title><?php echo SITE_NAME;?>: Test Summary Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Teacher/TeacherActivity/testSummryPrint.php");
?>
</body>
</html>
<?php 
// $History: testSummeryReportPrint.php $
//
//*****************  Version 1  *****************
