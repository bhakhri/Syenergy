<?php
//used for displaying tests summary
global $FE;
...
<title><?php echo SITE_NAME;?>: Display Tests  Summary </title>
<?php 
...
function getData(){
  if(document.getElementById('timeTableLabelId').value !=""){
          ...
          getClassFinalMarksList(document.getElementById('classId').value,document.getElementById('subject').value,document.getElementById('group').value);  
          document.getElementById('printDiv1').style.display='block';
       }
   else{
           messageBox("<?php echo DISPLAY_TESTS_SUMMERY; ?>");
           document.getElementById('timeTableLabelId').focus();
      } 
}

function getClassFinalMarksList(classId,subjectId,groupId){
  url = '<?php echo HTTP_LIB_PATH;?>/Teacher/TeacherActivity/ajaxTestSummery.php';
  var tableColumns = new Array(
                        ...
                        new Array('testTopic','Topic','width="10%" align="left"',true),
                        new Array('testTypeName','TestType','width="8%" align="left"',true), 
                        new Array('maxMarks','Max Marks','width="8%" align="right"',true),
                        new Array('testDate','Date','width="6%" align="center"',true)
                       );
 ...
 document.getElementById('totalTests').innerHTML='<b>Total Tests Conducted : '+listObj1.totalRecords;
...
/* function to print final marks report*/
function printFinalMarksReport() {
    ...
    if(document.getElementById('timeTableLabelId').value !=""){
     ...
     path='<?php echo UI_HTTP_PATH;?>/Teacher/testSummeryReportPrint.php?listStudent=1'+qstr;
...
/* function to export to csv final marks report*/
function csvFinalMarksReport() {
    ...
    if(document.getElementById('timeTableLabelId').value !=""){
     ...
     qstr=qstr+"&timeTableName="+document.getElementById('timeTableLabelId').options[document.getElementById('timeTableLabelId').selectedIndex].text;
     qstr=qstr+"&page="+listObj1.page+"&sortOrderBy="+listObj1.sortOrderBy+"&sortField="+listObj1.sortField;
     window.location='testSummeryReportCSV.php?queryString='+qstr;
    }
   else{
       messageBox("<?php echo DISPLAY_TESTS_SUMMERY; ?>");
       document.getElementById('timeTableLabelId').focus();
...
<?php 
	...
	require_once(TEMPLATES_PATH . "/Teacher/TeacherActivity/listTestsSummaryContents.php");
