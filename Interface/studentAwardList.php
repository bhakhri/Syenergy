...
define('MODULE','StudentAwardReport');
define('ACCESS','view');
...
<title><?php echo SITE_NAME;?>: Student Award Report </title>
<?php
...
function showReport(page) {
    ...
    var url = '<?php echo HTTP_LIB_PATH;?>/StudentFinalResultReport/initAwardReport.php';
...
function printReport() {
    ...
    form = document.testWiseMarksReportForm;
    pars = generateQueryString('testWiseMarksReportForm');
    path='<?php echo UI_HTTP_PATH;?>/studentAwardPrint.php?'+pars;
    window.open(path,"MarksDistributionReport","status=1,menubar=1,scrollbars=1, width=800,left=100,top=100");
}
...
form = document.testWiseMarksReportForm;
    pars = generateQueryString('testWiseMarksReportForm');
    path='<?php echo UI_HTTP_PATH;?>/studentAwardPrintCSV.php?'+pars;
