...
function saveData(){
   ...
   <?php 
      ...
      $isGraceCheck =  trim($sessionHandler->getSessionVariable('GRACE_MARKS_ALLOWED'));
   ?>
   if("<?php echo $isGraceCheck ?>"=="0"){
     messageBox("You cannot provide grace marks. Please contact your administrator for details");
     return false;
   }
...
function giveGraceMarks(){
   ...
   var url = '<?php echo HTTP_LIB_PATH;?>/AdminTasks/giveGraceMarks.php';
   new Ajax.Request(url,
           {
             method:'post',
             parameters: {
...
function subjectPopulate(value) {
   ...
   document.searchForm.subject.options.length=0;
...
<?php 
	...
	require_once(TEMPLATES_PATH . "/AdminTasks/graceMarksContents.php");
