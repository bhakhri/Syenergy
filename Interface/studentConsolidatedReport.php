...
function changeParameter(valueSelected){
	...
	if(valueSelected==1){
                document.getElementById('showGrades1').disabled = true; 
		document.getElementById('showGrades2').disabled = true;
		document.getElementById('showGraceMarks1').disabled = true; 
		document.getElementById('showGraceMarks2').disabled = true;
		...
		addOption(document.testWiseMarksReportForm.average, '4', 'Below Attendance');return false;
	}
	else if(valueSelected==2){
                document.getElementById('showGrades1').disabled = false; 
		document.getElementById('showGrades2').disabled = false;
		document.getElementById('showGraceMarks1').disabled = false; 
		document.getElementById('showGraceMarks2').disabled = false;
...
function disableOption(valueSelected){
...
function showReport() {
	...
	var url = '<?php echo HTTP_LIB_PATH;?>/StudentReports/initConsolidatedReportNew.php';
...
function printReport() {
	...
	showGraceMarks=0;
    if(!document.testWiseMarksReportForm.showGraceMarks[0].disabled && !document.testWiseMarksReportForm.showGraceMarks[1].disabled){
       if(document.testWiseMarksReportForm.showGraceMarks[1].checked==true) {
	 showGraceMarks=1;
	    }
               }
	...
	path='<?php echo UI_HTTP_PATH;?>/studentConsolidatedReportPrintNew.php?'+pars;
...
function printReportCSV() {
	...
	path='<?php echo UI_HTTP_PATH;?>/studentConsolidatedReportCSVNew.php?'+pars;
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/StudentReports/listStudentConsolidatedReport.php");
