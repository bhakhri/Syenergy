...
<title><?php echo SITE_NAME;?>: All Test Type Details Report Print </title>
<?php 
...
<?php 
    ...
    require_once(TEMPLATES_PATH . "/Index/listAllTestTypeReportPrint.php");
    //require_once(TEMPLATES_PATH . "/footer.php");
?>
</body>
</html>
<?php 
//$History: testTypeWisePrint.php $
//
//*****************  Version 2  *****************
