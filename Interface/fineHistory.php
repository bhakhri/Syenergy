...
<title><?php echo SITE_NAME;?>: Fine Payment History Report</title>
<?php 
...
var tableHeadArray = new Array(
                       ...
                       new Array('printAction','Action','width="14%"','align="center" nowrap',false)
                      );
      

recordsPerPage = <?php echo RECORDS_PER_PAGE;?>;
linksPerPage = <?php echo LINKS_PER_PAGE;?>;
listURL = '<?php echo HTTP_LIB_PATH;?>/Fine/ajaxFineList.php';
...
function printReport() {
	...
	var qstr=params+"&sortOrderBy="+sortOrderBy+"&sortField="+sortField; 
        path='<?php echo UI_HTTP_PATH;?>/fineHistoryReportPrint.php?'+qstr;  
...
function printPaymentHistoryCSV() {
	var params = generateQueryString('allDetailsForm');
	var qstr=params+"&sortOrderBy="+sortOrderBy+"&sortField="+sortField;
        path='<?php echo UI_HTTP_PATH;?>/fineHistoryReportCSV.php?'+qstr;
...
<?php 
    ...
    require_once(TEMPLATES_PATH . "/Fine/fineHistoryContents.php");
