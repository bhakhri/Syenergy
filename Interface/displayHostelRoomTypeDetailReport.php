...
<title><?php echo SITE_NAME;?>: Hostel Room Type Detail Report Print</title>
<?php 
...
<?php 
    ...
    require_once(TEMPLATES_PATH . "/HostelRoomTypeDetail/printHostelRoomTypeDetailReport.php");
    //require_once(TEMPLATES_PATH . "/footer.php");
?>
</body>
</html>
<?php
// $History: displayHostelRoomTypeDetailReport.php $ 
//
//*****************  Version 2  *****************
