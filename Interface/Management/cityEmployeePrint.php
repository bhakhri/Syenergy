<?php 
//-------------------------------------------------------
//  This File outputs the city employee to the Printer
//
...
<title><?php echo SITE_NAME;?>: City Employee Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/cityReportPrint.php");
?>
</body>
</html>
<?php 
// $History: cityEmployeePrint.php $
//
//*****************  Version 2  *****************
