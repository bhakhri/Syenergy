<?php 
//-------------------------------------------------------
//  This File outputs the teaching/non-teaching employee to the Printer
//
...
<title><?php echo SITE_NAME;?>: Teaching/Non-Teaching Employee Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/teachingReportPrint.php");
?>
</body>
</html>
<?php 
// $History: teachingEmployeePrint.php $
//
//*****************  Version 2  *****************
