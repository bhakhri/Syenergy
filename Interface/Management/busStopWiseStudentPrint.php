<?php 
//-------------------------------------------------------
//  This File outputs the bus stop wise for students to the Printer
//
...
<title><?php echo SITE_NAME;?>: Bus Stop Wise Student Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/studentBusStopReportPrint.php");
?>
</body>
</html>
<?php 
// $History: busStopWiseStudentPrint.php $
//
//*****************  Version 3  *****************
