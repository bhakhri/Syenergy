<?php 
//-------------------------------------------------------
//  This File outputs the studyperiod wise student to the Printer
//
...
<title><?php echo SITE_NAME;?>: Studyperiod Wise student Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/studyPeriodReportPrint.php");
?>
</body>
</html>
<?php 
// $History: periodWiseStudentPrint.php $
//
//*****************  Version 3  *****************
