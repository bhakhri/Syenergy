<?php 
//-------------------------------------------------------
//  This File outputs the role wise employee to the Printer
//
...
<title><?php echo SITE_NAME;?>: Role Wise Employee Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/roleWiseReportPrint.php");
?>
</body>
</html>
<?php 
// $History: roleWiseEmployeePrint.php $
//
//*****************  Version 2  *****************
