<?php
//-------------------------------------------------------
//  This File contains Validation and ajax function used in all details report of event for management.
//
//
...
require_once(BL_PATH . "/Management/fetchEventData.php");
?>
...
function amSliceClick(chart_id, index, title, value, percents, color, description){
	...
	path='<?php echo UI_HTTP_PATH;?>/Management/eventMonthPrint.php?listStudent=1&eventMonth='+description;
	//alert(path);
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/Management/allEventDetailsReport.php");
