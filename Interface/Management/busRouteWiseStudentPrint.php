<?php 
//-------------------------------------------------------
//  This File outputs the bus route wise for students to the Printer
//
...
<title><?php echo SITE_NAME;?>: Bus Route Wise Student Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/studentBusRouteReportPrint.php");
?>
</body>
</html>
<?php 
// $History: busRouteWiseStudentPrint.php $
//
//*****************  Version 3  *****************
