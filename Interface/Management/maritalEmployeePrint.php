<?php 
//-------------------------------------------------------
//  This File outputs the Marital employee to the Printer
//
...
<title><?php echo SITE_NAME;?>: Marital Employee Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/maritalReportPrint.php");
?>
</body>
</html>
<?php 
// $History: maritalEmployeePrint.php $
//
//*****************  Version 2  *****************
