<?php 
//-------------------------------------------------------
//  This File outputs the gender wise for students to the Printer
//
...
<title><?php echo SITE_NAME;?>: Gender Wise Student Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/studentGenderReportPrint.php");
?>
</body>
</html>
<?php 
// $History: genderWiseStudentPrint.php $
//
//*****************  Version 3  *****************
