<?php 
//-------------------------------------------------------
//  This File outputs the batch wise student to the Printer
//
...
<title><?php echo SITE_NAME;?>: Batch wise Student Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/studentBatchReportPrint.php");
?>
</body>
</html>
<?php 
// $History: batchWiseStudentPrint.php $
//
//*****************  Version 3  *****************
