<?php 
//-------------------------------------------------------
//  This File outputs the hostel detail wise employee to the Printer
//
...
<title><?php echo SITE_NAME;?>: Hostel Detail Wise Employee Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/studentHostelDetailReportPrint.php");
?>
</body>
</html>
<?php 
// $History: hostelDetailStudentPrint.php $
//
//*****************  Version 3  *****************
