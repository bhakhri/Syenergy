<?php 
//-------------------------------------------------------
//  This File outputs the Designation wise employee to the Printer
//
...
<title><?php echo SITE_NAME;?>: Designation wise Employee Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/designationReportPrint.php");
?>
</body>
</html>
<?php 
// $History: designationEmployeePrint.php $
//
//*****************  Version 2  *****************
