<?php 
//-------------------------------------------------------
//  This File outputs the hostel wise employee to the Printer
//
...
<title><?php echo SITE_NAME;?>: Hostel Wise Student Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/studentHostelReportPrint.php");
?>
</body>
</html>
<?php 
// $History: hostelWiseStudentPrint.php $
//
//*****************  Version 3  *****************
