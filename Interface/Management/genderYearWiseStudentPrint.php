...
<title><?php echo SITE_NAME;?>: Gender wise Student Year Wise Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/studentGenderYearReportPrint.php");
?>
</body>
</html>
<?php 
// $History: genderYearWiseStudentPrint.php $
//
//*****************  Version 2  *****************
