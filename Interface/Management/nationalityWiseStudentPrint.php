<?php 
//-------------------------------------------------------
//  This File outputs the nationality detail wise student to the Printer
//
...
<title><?php echo SITE_NAME;?>: Nationality Wise Student Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/studentNationalityReportPrint.php");
?>
</body>
</html>
<?php 
// $History: nationalityWiseStudentPrint.php $
//
//*****************  Version 3  *****************
