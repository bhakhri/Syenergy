...
<title><?php echo SITE_NAME;?>: Hostel wise Student Year Wise Report Print </title>
<?php 
...
<body>
<?php 
    require_once(TEMPLATES_PATH . "/Management/studentHostelYearReportPrint.php");
?>
</body>
</html>
<?php 
// $History: hostelYearWiseStudentPrint.php $
//
//*****************  Version 2  *****************
