<?php
//----------------------------------------------------------
//  This File Teacher load time table for print CSV format
//
//
...
<body>
  ...
  //  require_once(TEMPLATES_PATH . "/header.php");
    require_once(TEMPLATES_PATH . "/TimeTable/listLoadTimeTablePrintCSV.php");
   // require_once(TEMPLATES_PATH . "/footer.php");
    ?>
</body>
</html>
<?php 
//$History: displayLoadTeacherTimeTablePrintCSV.php $
//
//*****************  Version 1  *****************
