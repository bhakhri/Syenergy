...
<title><?php echo SITE_NAME;?>: Book Issue Master</title>
<?php 
...
listURL = '<?php echo HTTP_LIB_PATH;?>/BookIssue/ajaxInitList.php';
...
function validateForm() {
    ...
    if(fl==0){
       if(!confirm("All the books will be de-allocated from students of this class\nAre you sure?")){
           return false;
       }
    }
    
     var url = '<?php echo HTTP_LIB_PATH;?>/BookIssue/doBooksIssue.php';
     new Ajax.Request(url,
       {
         ...
         onSuccess: function(transport){
                 ...
                 if("<?php echo SUCCESS;?>" == trim(transport.responseText)) {
                     vanishData();
                     if(fl==0){
                         messageBox("All the books are de-allocated from students of this class");
                     }
                     else{
                         messageBox("Books issued successfully");    
                     }
...
<body>
	...
	require_once(TEMPLATES_PATH . "/BookIssue/listBookIssueContents.php");
