...
<title><?php echo SITE_NAME;?>: Feedback Category Response (Advanced)</title>
<?php 
 ...
 */ 
  ...
  var url = '<?php echo HTTP_LIB_PATH;?>/FeedbackAdvanced/ajaxGetCategoryResponseReport.php';
         new Ajax.Request(url,
           {
             method:'post',
             parameters: {
...
function printReport() {
   ...
   var path='<?php echo UI_HTTP_PATH;?>/categoryResponseReportPrint.php?'+qstr;
   
   window.open(path,"CategoryResponseReport","status=1,menubar=1,scrollbars=1, width=900, height=700, top=100,left=50");
}
...
function printCSV() {
   ...
   window.location='categoryResponseReportCSV.php?'+qstr;
}
...
<body>
	...
	require_once(TEMPLATES_PATH . "/FeedbackAdvanced/listFeedbackCategoryResponseReportContents.php");
