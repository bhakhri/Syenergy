...
<title><?php echo SITE_NAME;?>: Book Dispatch Master</title>
<?php 
...
listURL = '<?php echo HTTP_LIB_PATH;?>/BookDispatch/ajaxInitList.php';
...
function validateForm() {
    ...
    if(fl==0){
       if(!confirm("No books will be dispatched for students of this class\nAre you sure?")){
           return false;
       }
    }
    
     var url = '<?php echo HTTP_LIB_PATH;?>/BookDispatch/doBooksDispatch.php';
     new Ajax.Request(url,
       {
         ...
         onSuccess: function(transport){
                 ...
                 if("<?php echo SUCCESS;?>" == trim(transport.responseText)) {
                     vanishData();
                     if(fl==0){
                         messageBox("No books are dispatched for students of this class");
                     }
                     else{
                         messageBox("Books dispatched successfully");    
                     }
...
<body>
	...
	require_once(TEMPLATES_PATH . "/BookDispatch/listBookDispatchContents.php");
