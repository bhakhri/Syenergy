...
var tableHeadArray = new Array(
                        ...
                        new Array('companyName','Company Name','width="10%"','align="left"',true),
                        ...
                        new Array('companyPhone','Company Phone','width="15%"','align="left"',true),
                        new Array('action','Action','width="5%"','align="right"',false)
                       );

recordsPerPage = <?php echo RECORDS_PER_PAGE;?>;
linksPerPage = <?php echo LINKS_PER_PAGE;?>;
listURL = '<?php echo HTTP_LIB_PATH;?>/Supplier/ajaxInitSupplierList.php';
...
function addSupplier() {
         ...
         url = '<?php echo HTTP_LIB_PATH;?>/Supplier/ajaxInitSupplierAdd.php';
...
function deleteSupplier(id) {
         ...
         url = '<?php echo HTTP_LIB_PATH;?>/Supplier/ajaxInitSupplierDelete.php';
         new Ajax.Request(url,
           {
             method:'post',
...
function editSupplier() {
         url = '<?php echo HTTP_LIB_PATH;?>/Supplier/ajaxInitSupplierEdit.php';
...
//--------------------------------------------------------
         ...
         url = '<?php echo HTTP_LIB_PATH;?>/Supplier/ajaxSupplierGetValues.php';
         new Ajax.Request(url,
           {
             method:'post',
             parameters: {supplierId: id},
...
<body>
	<?php 
		...
		require_once(TEMPLATES_PATH . "/Supplier/listSupplierContents.php");
