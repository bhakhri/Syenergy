...
<title><?php echo SITE_NAME;?>Class Wise Head Mapping</title>
<?php 
            ...
            for(var i=0;i<total;i++) {
                if(obj[i].type.toUpperCase()=='HIDDEN' && obj[i].name.indexOf('idNos[]')>-1) {
                   ...
                   if(!isDecimal(trim(eval("document.getElementById('totalAmount"+id+"').value")))) {                          
                    ...
                    if (eval("document.getElementById('totalAmount"+id+"').value")<0 || eval("document.getElementById('totalAmount"+id+"').value")>100) {                          
                     messageBox ("Value should be between 0 to 100");
                     eval("document.getElementById('totalAmount"+id+"').focus()");  
                     return false;
                   }
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/ClassWiseHeadMapping/classWiseHeadMappingContents.php");
