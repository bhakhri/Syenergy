...
<title><?php echo SITE_NAME;?>: Approved Requisition </title>
<style>
...
var tableHeadArray = new Array(
				...
				new Array('userName','Requesting User','width="15%"','align="center"',true),
                                new Array('action1','Action','width="5%"','align="center"',false)
                              );

recordsPerPage = <?php echo RECORDS_PER_PAGE;?>;
linksPerPage = <?php echo LINKS_PER_PAGE;?>;
listURL = '<?php echo INVENTORY_HTTP_LIB_PATH;?>/RequisitionMaster/ajaxInitApprovedRequisitionList.php';
...
function editApprovedRequisition() {
         url = '<?php echo INVENTORY_HTTP_LIB_PATH;?>/RequisitionMaster/ajaxInitApprovedRequisition.php';
         var pars = generateQueryString('EditApprovedRequisition');
...
function rejectRequisition() {
	 url = '<?php echo INVENTORY_HTTP_LIB_PATH;?>/RequisitionMaster/ajaxInitRejectRequisition.php';
	 var pars = generateQueryString('EditApprovedRequisition');
...
function populateValues(id,dv,w,h) {
		...
		//cleanUpEditTable();
         ...
         url = '<?php echo INVENTORY_HTTP_LIB_PATH;?>/RequisitionMaster/ajaxGetApprovedRequisitionValues.php';
         new Ajax.Request(url,
           {
             method:'post',
			 asynchronous: false,
             ...
             onSuccess: function(transport){
				   ...
				   document.getElementById('approvedRequisitionDiv').style.display = '';
				   document.getElementById('approvedRequisitionDiv').innerHTML = '';

				   document.getElementById('approvedRequisitionDiv').innerHTML = j['approvedRequisitionDiv'];
...
/* function to print data*/
 ...
 function printReport() {
	 var path='<?php echo INVENTORY_UI_HTTP_PATH;?>/displayApprovedRequisitionReport.php?searchbox='+trim(document.searchForm.searchbox.value)+'&sortOrderBy='+sortOrderBy+'&sortField='+sortField;
    //window.open(path,"DisplayHostelReport","status=1,menubar=1,scrollbars=1, width=900");
    try{
     var a=window.open(path,"approvedRequisitionReport","status=1,menubar=1,scrollbars=1, width=900, height=700, top=100,left=50");
    }
    catch(e){
...
function printCSV() {
    ...
    var path='<?php echo INVENTORY_UI_HTTP_PATH;?>/approvedRequisitionReportCSV.php?'+qstr;
...
<body>
    ...
    require_once(INVENTORY_TEMPLATES_PATH . "/RequisitionMaster/listApprovedRequisitionContents.php");
