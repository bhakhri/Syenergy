...
<title><?php echo SITE_NAME;?>: Display Time Table Report Print </title>
<?php 
...
<?php 
    ...
    require_once(TEMPLATES_PATH . "/Parent/displayTimeTableReportPrint.php");
...
//History: $displayTimeTableReport.php 
//
