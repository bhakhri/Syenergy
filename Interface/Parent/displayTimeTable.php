...
define('MODULE','ParentStudentTimeTable');
define('ACCESS','view');
...
function printCSV() {   
      form=document.addForm;
      path='<?php echo UI_HTTP_PATH;?>/Parent/displayTimeTableReportCSV.php?currentClassId='+<?php echo $studentDataArr[0]['classId']; ?>+'&rClassId='+document.getElementById('studyPeriod').value;
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/Parent/timeTableContents.php");
