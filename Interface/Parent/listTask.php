...
function getTask(){
 ...
 var tableColumns = new Array(
                        ...
                        new Array('title','Title','width="20%" align="left"',true),
						new Array('shortDesc','Short Description','width="20%" align="left"',true),
...
function addTask() {
         ...
         url = '<?php echo HTTP_LIB_PATH;?>/Parent/ajaxInitTaskAdd.php';
...
function deleteTask(id) {
         ...
         url = '<?php echo HTTP_LIB_PATH;?>/Parent/ajaxInitTaskDelete.php';
...
//--------------------------------------------------------
function editTask() {
         url = '<?php echo HTTP_LIB_PATH;?>/Parent/ajaxInitTaskEdit.php';
...
<body>
	<?php 
		...
		require_once(TEMPLATES_PATH . "/Parent/listTaskContents.php");
