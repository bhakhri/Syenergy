...
define('MODULE','AttendanceNotEnteredReport');
define('ACCESS','view');
...
<title><?php echo SITE_NAME;?>: Attendance Not Entered Report </title>
<?php 
require_once(TEMPLATES_PATH .'/jsCssHeader.php'); 
?> 
<script language="javascript">

var tableHeadArray = new Array(new Array('srNo','#','width="5%"','',false), new Array('className','Class','width=20%','',true), new Array('subjectCode','Subject','width="15%"','',true), new Array('groupName','Group','width="10%"','',true), new Array('employeeName','Faculty','width="20%"','',true), new Array('toDate','Last Attendance Date','width="15%"',"align='center'",false)); 

 //This function Validates Form 
var listURL='<?php echo HTTP_LIB_PATH;?>/StudentReports/initGetMissedAttendanceReport.php';
...
function resetSubject() {
	hideDetails();
	if(document.attendanceMissedForm.degree.value == "all" || document.attendanceMissedForm.degree.value == "") {
...
function printReport() {
	...
	path='<?php echo UI_HTTP_PATH;?>/missedAttendanceReportPrint.php?labelId='+form.labelId.value+'&degree='+form.degree.value+'&subjectId='+form.subjectId.value+'&tillDate='+form.tillDate.value+'&sortOrderBy='+sortOrderBy+'&sortField='+sortField;
	window.open(path,"MissedAttendanceReport","status=1,menubar=1,scrollbars=1, width=900");
}

function printCSV() {
    form = document.attendanceMissedForm;
	path='<?php echo UI_HTTP_PATH;?>/missedAttendanceReportCSV.php?labelId='+form.labelId.value+'&degree='+form.degree.value+'&subjectId='+form.subjectId.value+'&tillDate='+form.tillDate.value+'&sortOrderBy='+sortOrderBy+'&sortField='+sortField;
...
<body>
    ...
    require_once(TEMPLATES_PATH . "/StudentReports/listAttendanceMissedReport.php");
...
//$History: attendanceMissedReport.php $
//
//*****************  Version 11  *****************
