<?php
//-------------------------------------------------------
//  This File is used for Parent role permission
//
//
...
define('MODULE','ParentRolePermissions');
define('ACCESS','view');
...
<title><?php echo SITE_NAME;?>: Parent Role Permissions </title>
<?php 
...
*/
   uncheckAll();
   form = document.listForm;
   url = '<?php echo HTTP_LIB_PATH;?>/RolePermission/ajaxParentGetRolePermissions.php';
...
function savePermissions() {
   ...
   url = '<?php echo HTTP_LIB_PATH;?>/RolePermission/ajaxParentSaveRolePermissions.php';
    new Ajax.Request(url,
    {
	     method:'post',
...
<body>
	...
	require_once(TEMPLATES_PATH . "/RolePermission/listParentRolePermission.php");
    require_once(TEMPLATES_PATH . "/footer.php");
    ?>
</body>
</html>
<?php 
// $History: parentPermission.php $
//
//*****************  Version 1  *****************
