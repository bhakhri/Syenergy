...
//----------------------------------------------------------------------------------
    ...
    public function insertSurveyVisibleToUsersData($insertQuery) {
        ...
        $query="INSERT INTO
                ...
                ( feedbackMappingId,userId,roleId, classId, studentId ) VALUES $insertQuery
                ";
        return SystemDatabaseManager::getInstance()->executeUpdateInTransaction($query);
    }
    ...
    public function doClassSubjectMapping($subjectInsertString) {
        ...
        $query="INSERT INTO
                           feedbackadv_to_class_subjects
                ( feedbackMappingId,subjectId, classId ) VALUES $subjectInsertString
                ";
        return SystemDatabaseManager::getInstance()->executeUpdateInTransaction($query);
    }
...
/*These functions are needed for displaying repors*/
    ...
    public function getCheckUserStudent($conditions='') {
