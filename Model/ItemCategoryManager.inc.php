...
//--------------------------------------------------------    
    public function addItemCategory() {
     ...
     $query="INSERT INTO item_category (categoryName,abbr) 
      VALUES('".addslashes($REQUEST_DATA['categoryName'])."','".addslashes(strtoupper($REQUEST_DATA['abbr']))."')"; 
...
//--------------------------------------------------------        
    public function editItemCategory($id) {
     ...
     $query="UPDATE item_category SET categoryName ='".addslashes($REQUEST_DATA['categoryName'])."',abbr ='".addslashes(strtoupper($REQUEST_DATA['abbr']))."'
