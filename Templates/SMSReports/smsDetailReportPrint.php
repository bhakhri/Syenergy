...
*/
   ...
   /// Search filter /////  
    ...
    $reportHead .= "<b>Date</b>:&nbsp;".UtilityManager::formatDate($REQUEST_DATA['fromDate']).
		   "&nbsp;&nbsp;to&nbsp;&nbsp;".UtilityManager::formatDate($REQUEST_DATA['toDate']);
    ...
    $reportTableHead['dated']        = array('Date Sent',             'width="15%" align="center"', 'align="center"');
    ...
    $reportTableHead['messageType']  = array('Type of Messges',  'width="15%" align="left"', 'align="left"');
