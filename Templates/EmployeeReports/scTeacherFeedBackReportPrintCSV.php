...
//--------------------------------------------------------
    ...
    //  $surveyStudent = $FeedBackArray[0]['totalStudent'];
    //}    
    ...
    //$csvData .= "Total no. of students registered in the course in sections allocated to you, $studentAssign, No. of students who responded to the feedback, $surveyStudent \n"; 
