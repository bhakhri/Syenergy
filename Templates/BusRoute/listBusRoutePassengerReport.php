<?php 
//This file creates Html Form output for Bus Route Passenger Report
//
// Author :Jaineesh
// Created on : 12.07.10
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contenttab_border2">
							<tr>
								<td valign="top" class="contenttab_row1">
									<form name="busRouteForm" action="" method="post" onSubmit="return false;">
										<table align="center" border="0" >
											<tr>
												<td class="contenttab_internal_rows1" align="right"><nobr><b>Bus Route</b></nobr></td>
												<td class="padding" ><b>:&nbsp;</b><select size="1" class="inputbox1" name="busRouteId" id="busRouteId">
							...
							<tr id='nameRow' style='display:none;'>
								<td class="" height="20">
									<table width="100%" border="0" cellspacing="0" cellpadding="0" height="20"  class="contenttab_border">
										<tr>
											<td colspan="1" class="content_title">Bus Route Passenger List :</td>
											<!--
