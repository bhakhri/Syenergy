...
<select size="1"  name="attendanceCodeId" id="attendanceCodeId" style='display:none;'>     
  <?php
							...
							<tr>
								<td valign="top" class="contenttab_row1">
										...
										<table align="center" border="0" >
											<tr>
												<td class="contenttab_internal_rows1" align="right"><nobr><b>Time Table<?php echo REQUIRED_FIELD ?></b></nobr></td>
												<td class="padding" ><b>:&nbsp;</b>
                                                <select style="width:200px" size="1" class="inputbox1" name="labelId" id="labelId" onchange="getTimeTableClasses();">
												...
												<td class="contenttab_internal_rows1" align="right">
													<strong>Degree<?php echo REQUIRED_FIELD ?></strong>
												</td>
												<td class="padding"><b>:</b>
													<select size="1" class="selectfield" name="degree" id="degree" style="width:250px"  onchange="getClassSubjects();">
														<option value="">Select</option>
														<?php 
															//require_once(BL_PATH.'/HtmlFunctions.inc.php');
							...
							<tr id='nameRow' style='display:none;'>
								<td class="" height="20">
									<table width="100%" border="0" cellspacing="0" cellpadding="0" height="20"  class="contenttab_border">
										<tr>
											<td colspan="1" class="content_title">Student Attendance Report :</td>
