                                        ...
                                        <table width="100%" border="0" cellspacing="2px" cellpadding="0px">
                                            <tr>
                                                ...
                                                <td class="contenttab_internal_rows" nowrap >
                                                    <select size="1" class="inputbox1" name="timeTable" id="timeTable" onChange="getLabelClass()" style="width:190px">
                                               ...
                                               <td class="contenttab_internal_rows" nowrap ><strong>Degree</strong> </td>
                                                <td class="contenttab_internal_rows" nowrap ><nobr><strong>:</strong></nobr></td>
                                                <td class="contenttab_internal_rows" nowrap >
                            <select size="1" class="selectfield" name="degree" id="degree" onChange="getClassSubjects();"  style="width:340px">
                                                ...
                                                <td style="display:none" class="contenttab_internal_rows" nowrap ><strong>Subject Type</strong> </td>
                                                <td style="display:none" class="contenttab_internal_rows" nowrap ><nobr><strong>:</strong></nobr></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="contenttab_internal_rows" nowrap ><nobr><strong>:</strong></nobr></td>
                                                <td class="contenttab_internal_rows" nowrap >
                                                    <select name="groupId"  class="selectfield" id="groupId" style="width:190px" onchange="hideResults();">
                                                        <option value="">ALL</option>
                                                    </select>
                                                </td>
                                                ...
                                                <td class="contenttab_internal_rows" nowrap colspan="10">
                                                    ...
                                                    <tr>
                                                        <td class="contenttab_internal_rows" nowrap >
                                                            <select size="1" class="inputbox1" name="marksFor" id="marksFor"  style="width:90px"  >
                                                                <option value="0">Both</option>
                                                                <option value="1">Internal</option>
                                                                <option value="2">External</option>
                                                                <option value="3">Grand Total</option>    
                                                            </select>
                                                        </td>
                                                        <td class="contenttab_internal_rows" style="padding-left:15px" nowrap ><strong>Report For</strong> </td>
                                                        <td class="contenttab_internal_rows" nowrap ><nobr><strong>:</strong></nobr></td>
                                                        <td class="contenttab_internal_rows" nowrap >
                                                            <select size="1" class="inputbox1" name="reportFor" id="reportFor" style="width:90px" onChange="changeParameter(this.value)">
                                                                <option value="2">Marks</option>
                                                                <option value="1">Attendance</option>
                                                                <!--option value="0">Both</option-->
                                                            </select>
                                                        </td>
                                                        <td class="contenttab_internal_rows" style="padding-left:15px" nowrap  align="left">
                                            ...
                                            <tr>
                                               ...
                                               <td class="contenttab_internal_rows" nowrap ><nobr><strong>:</strong></nobr></td>
                                               <td class="contenttab_internal_rows" nowrap >
                                                   <select size="1" class="inputbox1" name="sortField1" id="sortField1" style="width:190px">
                                               ...
                                               <td class="contenttab_internal_rows" colspan="20">
                                                    <table width="40%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                      <tr>
                                                        ...
                                                        <td class="contenttab_internal_rows" nowrap style="padding-left:15px"><strong>Show Grace Marks</strong> </td>
                                                  ...
                                                  <td class="contenttab_internal_rows" nowrap colspan="10">
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td class="contenttab_internal_rows" nowrap>
                                                            <input type="text" name="range" style="width:570px" id="range" value="<?php require_once(BL_PATH.'/HtmlFunctions.inc.php');
...
<td class="contenttab_internal_rows"  style="padding-left:55px" valign="top" nowrap>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr id='resultRow'>
                                ...
                                <div id="scroll" style="OVERFLOW: auto; HEIGHT:300px;width:980px; TEXT-ALIGN: justify;">
                                    <div id = 'results'></div>
                                </div>
                                </td>
                            </tr>
