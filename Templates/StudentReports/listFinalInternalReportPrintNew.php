...
//--------------------------------------------------------
    ...
    // Check for Pagination  (start)
    $pageRecordLimit ='30';
    
    $pageCounter = '1';
    $totalPages = '1';
    
    $cntPage = count($studentArray2)/$pageRecordLimit;
    ...
    $searchHeading = '';
    $searchHeading .= "<b>Class&nbsp;:</b>".$className;  
    $searchHeading .= "<br>";   
    $searchHeading .= "<b>Subject&nbsp;:</b>".$subjectName." (".$subjectCode.")";
    $searchHeading .= "<br>";   
    $searchHeading .= "<b>Teachers&nbsp;:</b>".$teacherName;
    $searchHeading .= "<br>";   
    $searchHeading .= "<b>Avg&nbsp;:</b>".$average;
    ...
    getFinalResult($allDetailsArray);
    

die;    


function getFinalResult($allDetailsArray) {
        ...
        if ($totalTests == 0 || count($allDetailsArray['resultData'])== 0) { 
            ...
            $tableData .= '<tr><td width="2%" '.$reportManager->getReportDataStyle().' >#</td>';
            if($showUnivRollNo == '1') {
              $tableData .= '<td width="8%" class="searchhead_text reportBorder">U.Roll No.</td>';
            }
            $tableData .= '<td width="8%"  '.$reportManager->getReportDataStyle().' >Roll No.</td>';
            $tableData .= '<td width="20%"  '.$reportManager->getReportDataStyle().' >Student Name</td>';
            $tableData .= '<td width=62%  '.$reportManager->getReportDataStyle().' >&nbsp;</td></tr><tr '.$bg.'>';
            $tableData .= '<td  '.$reportManager->getReportDataStyle().'  align=center colspan=5>No details found</td></tr>';
            $tableData .= '</table>';
            ...
            $tableData = '<table border="1" cellpadding="1" cellspacing="1" width="800px"  class="reportTableBorder" >';
            $tableData .= '<tr><td rowspan="3" width="2%"  '.$reportManager->getReportDataStyle().' >#</td>';
            if($showUnivRollNo == '1') {
              $tableData .= '<td rowspan="3" width="8%" '.$reportManager->getReportDataStyle().' >U.Roll No.</td>';
            }
            $tableData .= '<td rowspan="3" width="8%" '.$reportManager->getReportDataStyle().' >Roll No.</td>';
            $tableData .= '<td width="20%" rowspan="3" '.$reportManager->getReportDataStyle().' >Student Name</td>';
            ...
            for($i=0;$i<$totalTests;$i++) {
                ...
                $testTypeName = $allDetailsArray['testTypes'][$i]['testTypeName'];
                if($isAttendanceCategory == 1 || $isAttendanceCategory == "1") {
                  $tableData .= '<td align="center" '.$reportManager->getReportDataStyle().'  colspan = "7">Attendance&nbsp;</td>';
                }
                else {
                    $testTypeCategoryIdTests = count($allDetailsArray[$testTypeCategoryId]);  
                    ...
                    $tableData .= '<td align="center" '.$reportManager->getReportDataStyle().'  colspan = "'.$thisColSpan.'">'.$testTypeName.'&nbsp;</td>';
                    $allTests .= $testTypeCategoryIdTests;
                    $allTests++;//for evaluated marks
                }
            }
            ...
            if ($showGraceMarksValue == '1') {
              if($showExternalMarks=='1') {     
                $tableData .= '<td align="center" '.$reportManager->getReportDataStyle().'  colspan="3" colspan = "1">Grace</td>';
              }
              else {
                $tableData .= '<td align="center" '.$reportManager->getReportDataStyle().' colspan="2" colspan = "1">Grace</td>';  
              }
            }
            $tableData .= '<td align="right" '.$reportManager->getReportDataStyle().'  colspan = "1">Internal</td>';  
            
            if($showExternalMarks=='1') {    
              $tableData .= '<td align="right" '.$reportManager->getReportDataStyle().'  colspan = "1">External</td>';
            }
            
            $tableData .= '<td align="right" '.$reportManager->getReportDataStyle().'  rowspan="3" colspan = "1">G.Total</td>';
            $tableData .= '</tr>';
            $tableData .= '<tr>';
            ...
            for($i=0;$i<$totalTests;$i++) {
                ...
                if ($isAttendanceCategory == 1 || $isAttendanceCategory == "1") {
                    $tableData .= '<td align="right" rowspan="2"  '.$reportManager->getReportDataStyle().'  colspan = "1">Held</td>';
                    $tableData .= '<td align="right" rowspan="2" '.$reportManager->getReportDataStyle().'  colspan = "1">Attended</td>';
                    $tableData .= '<td align="right" rowspan="2" '.$reportManager->getReportDataStyle().'  colspan = "1">DL</td>';
                    $tableData .= '<td align="right" rowspan="2" '.$reportManager->getReportDataStyle().'  colspan = "1">ML</td>';
                    $tableData .= '<td align="right" rowspan="2" '.$reportManager->getReportDataStyle().'  colspan = "1">Total</td>';
                    $tableData .= '<td align="right" rowspan="2" '.$reportManager->getReportDataStyle().'  colspan = "1">%</td>';
                    $tableData .= '<td align="right" rowspan="2" '.$reportManager->getReportDataStyle().'  colspan = "1">M.M.<br> '.(round($testTypeMaxMarks*10)/10).'</td>';
                }
                else {
                    $testTypeCategoryIdTests = count($allDetailsArray[$testTypeCategoryId]);     
                    for($m=0; $m<$testTypeCategoryIdTests; $m++) {
                        ...
                        if($showTestMarks=='1') {  
                          $tableData .= '<td align="center" '.$reportManager->getReportDataStyle().'  colspan="2">'.$testCode.'&nbsp;</td>';  
                        }
                        else {
                          $tableData .= '<td align="center" '.$reportManager->getReportDataStyle().'  rowspan="1">'.$testCode.'&nbsp;</td>';
                        }
                    }
                    $tableData .= '<td align="right" '.$reportManager->getReportDataStyle().'  rowspan="2" colspan = "1">M.M.<br> '.(round($testTypeMaxMarks*10)/10).'</td>';
                }
            }

            
            if ($showGraceMarksValue == '1') {    
              $tableData .= '<td align="right" '.$reportManager->getReportDataStyle().'  rowspan="2"  colspan = "1">Internal</td>';
              if($showExternalMarks=='1') { 
                $tableData .= '<td align="right"'.$reportManager->getReportDataStyle().'  rowspan="2"  colspan = "1">External</td>';
              }
              $tableData .= '<td align="right" '.$reportManager->getReportDataStyle().'  rowspan="2"  colspan = "1">Total</td>';
            }
            ...
            */
            ...
            $tableData .= '<td align="right" '.$reportManager->getReportDataStyle().'  rowspan="2" colspan = "1">'.$intMksWeightage.'</td>';
            
            // External Marks
            if($showExternalMarks=='1') {
              $tableData .= '<td align="right" '.$reportManager->getReportDataStyle().'  rowspan="2" colspan = "1">'.number_format($showExternalTotalMarks,2).'</td>';  
            }
            ...
            for($i=0;$i<$totalTests;$i++) {
                ...
                if ($isAttendanceCategory == 1 || $isAttendanceCategory == "1") {
                    ...
                    for ($m = 0; $m < $testTypeCategoryIdTests; $m++) {
                        ...
                        if($showTestMarks=='1') {
                          $tableData .= '<td align="right" '.$reportManager->getReportDataStyle().' >MO&nbsp;</td>
                                         <td align="right" '.$reportManager->getReportDataStyle().' >MM&nbsp;</td>'; 
                        }
                        else {
                          $tableData .= '<td align="right" '.$reportManager->getReportDataStyle().' >'.(round($indiTestMaxMarks*10)/10).'&nbsp;</td>';
                        }
                    }
                } 
            }
            ...
            for($x = 0; $x < $resultDataLength; $x++) {
                ...
                $tableData .= '<tr>';
                $tableData .= '<td '.$reportManager->getReportDataStyle().' >'.$allDetailsArray['resultData'][$x]['srNo'].'&nbsp;</td>';
                ...
                if ($showUnivRollNo == '1') {
                   $tableData .= '<td align="center"  '.$reportManager->getReportDataStyle().' >'.$allDetailsArray['resultData'][$x]['universityRollNo'].'&nbsp;</td>';
                }
                ...
                $tableData .= '<td '.$reportManager->getReportDataStyle().' >'.$allDetailsArray['resultData'][$x]['rollNo'].'&nbsp;</td>';
                $tableData .= '<td '.$reportManager->getReportDataStyle().' >'.$allDetailsArray['resultData'][$x]['studentName'].'&nbsp;</td>';
                ...
                for($i=0;$i<$totalTests;$i++) {
                    ...
                    if ($isAttendanceCategory == 1 || $isAttendanceCategory == "1") {
                        ...
                        $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right"  colspan = "1">'.$lectureDelivered.'</td>';
                        $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right"   colspan = "1">'.$lectureAttended.'</td>';
                        $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="'.$align.'"   colspan = "1">'.$dutyLeave.'</td>';
                        $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="'.$align.'"   colspan = "1">'.$medicalLeave.'</td>';
                        $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right"   colspan = "1">'.$totalAttended.'</td>';
                        $percentAttended = 0;
                        ...
                        $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right"   colspan = "1">'.$percentAttended.'</td>';
                        ...
                        $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right"  colspan = "1"><B>'.$ms_attendance.'</B></td>';
                    }
                    else {
                        $testTypeCategoryIdTests = count($allDetailsArray[$testTypeCategoryId]); 
			            $mm=0;
                        ...
                        for ($m = 0; $m < $testTypeCategoryIdTests; $m++) {
                            ...
                            if($showTestMarks=='1') {
                                ...
                                $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="'.$align.'" nowrap>'.$actualMarksScored.'</td>';  
                                $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="'.$align.'" nowrap>'.$actualMaxMarks.'</td>';  
                            }
                            else {
                                ...
                                $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="'.$align.'" nowrap>'.$studentMarks.'</td>';
                            }
                        }
                        ...
                        */
                        $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right"><B>'.number_format($studentMarks,2).'</B>&nbsp;</td>';  
                ...
                if ($showGraceMarksValue == '1') {
                    ...
                    $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right">'.$graceMarksInt.'&nbsp;</td>';
                    if($showExternalMarks=='1') { 
                      $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right">'.$graceMarksExt.'&nbsp;</td>';
                    }
                    $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right">'.$graceMarksTot.'&nbsp;</td>';
                ...
                $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right"><B>'.$studentTotalMarks.'</B>&nbsp;</td>'; 
                
                if($showExternalMarks=='1') {
                  $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right"><B>'.number_format($externalMarks,2).'&nbsp;</B></td>';
                ...
                $tableData .= '<td  '.$reportManager->getReportDataStyle().' align="right"><B>'.$grandTotal.'</B>&nbsp;</td>';
                $tableData .= '</tr>';
                
               $reportDataFind++;    
               if($reportDataFind==$pageRecordLimit) {
                  $tableData .= "</table>";  
                  echo reportGenerate($tableData);    
                  $reportDataFind='0';
                  $tableData = '';
...
// Report generate
    function reportGenerate($value) {
        ...
        $reportManager->setReportHeading('Final Marks Report');
        $reportManager->setReportInformation("$searchHeading");     
      ?>
        <div>
