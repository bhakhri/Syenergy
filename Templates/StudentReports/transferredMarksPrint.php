...
?>
	...
	<tr><th colspan="3" <?php echo $reportManager->getReportHeadingStyle(); ?> align="center">Student Consolidated Report</th></tr>
	 
	<tr><th colspan="3" <?php echo $reportManager->getReportInformationStyle(); ?>>For <B>Class:</B><?php echo $degreeName?> <B>Subject Type:</B> <?php echo $typeName?> <B>Subject :</B> <?php echo $subjectName?></th></tr>
