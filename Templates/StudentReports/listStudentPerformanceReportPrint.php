...
<?php
	...
	$studentName = $studentIdClassArray[0]['firstName'].' '.$studentIdClassArray[0]['lastName'];
	$className = $studentIdClassArray[0]['className'];
	$classId = $studentIdClassArray[0]['classId'];
	...
	$reportManager->setReportHeading('Student Performance Report');
	$reportManager->setRecordsPerPage(40);
	

	$reportManager->setReportInformation("Student Name : $studentName, Degree : $className");

	$reportManager->setReportData(array(), $dataArray);
	$reportManager->showStudentPerformanceReport();

//$History: listStudentPerformanceReportPrint.php $
//
//*****************  Version 1  *****************
