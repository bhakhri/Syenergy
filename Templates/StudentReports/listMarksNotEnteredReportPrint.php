...
<?php
	...
	$subjectIdPosted = $REQUEST_DATA['subjectId'];
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	$reportManager->setReportHeading('Marks Entered Report');
	$reportManager->setReportInformation("Degree(s) : $className2, Subject(s) : $subCode, Group(s) : $groupName");
	...
	$reportTableHead['subjectCode']				=	array('Subject',				'width="20%" align="left" ', 'align="left"');
	...
	$reportTableHead['testName']				=	array('Test Name',				'width="20%" align="left"','align="left"');
