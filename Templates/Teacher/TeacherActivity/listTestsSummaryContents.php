...
?>
    ...
    <tr>
        <td valign="top" class="title">
            ...
            <tr>
                <td valign="top">Marks & Attendance &nbsp;&raquo;&nbsp; Display Tests Summary </td>
            ...
            <tr>
             ...
             <tr>
                <td class="contenttab_border" height="20">
                    ...
                    <tr>
                        <td class="content_title">Display Tests Summary : </td>
                        <td align="right" valign="middle"><div id="printDiv1" style="display:none"><input type="image" name="imageField" src="<?php echo IMG_HTTP_PATH; ?>/print.gif" onClick="printFinalMarksReport();return false;"/>&nbsp;<input type="image" name="imageField" src="<?php echo IMG_HTTP_PATH; ?>/excel.gif" onClick="csvFinalMarksReport();return false;"/></div></td>
                    </tr>
                    </table>
                </td>
             </tr>
...
<?php
// $History: listTestsSummaryContents.php $
//
//*****************  Version 1  *****************
