    ...
    <tr>
        <td class="title">
			...
			<?php require_once(TEMPLATES_PATH . "/breadCrumb.php");        ?> 
               <!-- <td valign="middle">Messaging &nbsp;&raquo;&nbsp;Send Message to Parents Mail Box</td>  -->  
            </tr>
            </table>
        </td>
    </tr>
             ...
             <tr>
                <td class="contenttab_border" height="20">
                    ...
                    <tr>
                        ...
                        <td class="content_title" title="Compose Message">
                         <!-- <img src="<?php echo IMG_HTTP_PATH;?>/mail.gif" align="right" onClick="displayWindow('ParentTeacherActionDiv',680,250);blankValues();return false;" />&nbsp; -->
                        </td>
                    </tr>
                    </table>
                </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="border">
    ...
    <tr id="replyMessage1">
        <td class="contenttab_internal_rows">&nbsp;<nobr><strong>Student Roll No.</strong><?php echo REQUIRED_FIELD?></nobr></td>
        <td class="contenttab_internal_rows"><nobr><strong>:</strong></nobr></td>
        <td class="padding" >
           <input type='text' class='selectfield' autocomplete='off' name='rollNo' id='rollNo' maxlength="25" style='width:197px'/>
        </td>
    </tr>
    <tr id="replyMessage4" style="display:''"> 
        <td width="15%" class="contenttab_internal_rows">&nbsp;<nobr><strong>Mail To</strong><?php echo REQUIRED_FIELD;?></nobr></td>
        <td class="contenttab_internal_rows"><nobr><strong>:</strong></nobr></td>
        <td class="padding" colspan="7">
          <!-- <input type="checkbox" name="chb[]" value="F">Father&nbsp;&nbsp;<input type="checkbox" name="chb[]" value="M">Mother&nbsp;&nbsp; 
            <input type="checkbox" name="chb[]" value="G">Guardian 
          -->
