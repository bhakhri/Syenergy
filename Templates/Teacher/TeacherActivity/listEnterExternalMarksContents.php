             ...
             <form action="" method="" name="searchForm">
               <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                    <tr>    
                        ...
                        <td width="20%" class="padding"><select size="1" class="selectfield" name="class" id="class" onchange="blankValues(1);"  >
                        ...
                        <td width="20%" class="padding"><select size="1" class="selectfield" name="subject" id="subject" onchange="populateTestType(this.value);blankValues(1);" >
                        ...
                        <td width="20%" class="padding"><select size="1" class="selectfield" name="group" id="group"  onchange="blankValues(1);">
...
<?php
// $History: listEnterExternalMarksContents.php $
//
//*****************  Version 2  *****************
