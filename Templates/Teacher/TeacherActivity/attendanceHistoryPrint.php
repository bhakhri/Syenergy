...
//--------------------------------------------------------
    ...
    if($roleId!=2){
      $search =" Time Table : ".trim($REQUEST_DATA['timeTableLabel'])." Teacher :".trim($REQUEST_DATA['employeeName']);
    }
   ...
   if($attHistoryString!=''){
    ...
    $reportTableHead['fromDate']         =   array('From','width="7%" align="center" ', 'align="center"');
    $reportTableHead['toDate']           =   array('To','width="7%" align="center" ', 'align="center"');
