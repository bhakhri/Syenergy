...
<iframe id="uploadTargetAdd" name="uploadTargetAdd" style="width:0px;height:0px;border:0px solid #fff;"></iframe> 
	 ...
	 <tr>
		<td class="contenttab_internal_rows" nowrap width="2%" >&nbsp;&nbsp;&nbsp;<nobr><b>Date</b></nobr></td>
		<td class="contenttab_internal_rows" nowrap width="2%" ><nobr><b>:</b></nobr></td>
		<td colspan="1" class="padding" nowrap width="2%" ><nobr>
		<?php
		require_once(BL_PATH.'/HtmlFunctions.inc.php');
		 echo HtmlFunctions::getInstance()->datePicker('dateOfEntry',date('Y')."-".date('m')."-".date('d'));
	      ?></nobr>
	   </td>
		<td class="contenttab_internal_rows" nowrap width="2%" ><nobr></nobr></td> 
		<td class="contenttab_internal_rows" nowrap width="2%" ><nobr><b>Event Name<?php echo REQUIRED_FIELD ?></b></nobr></td>
		<td class="padding" width="2%" nowrap >:&nbsp;
		    <input style="width:400px" name="eventName" id="eventName" class="inputbox" value="" />
	        </td>
	 </tr>
    </table>	
   ...
   <table width="10%" border="0" cellspacing="0" cellpadding="0">
    <tr>
       <td width="100%" style="width:650px;" >
		...
		<tbody id="anyidBody">
		    <tr class="rowheading">
		        <td width="5%" class="contenttab_internal_rows"><b>#</b></td>
		         <td width="30%" class="contenttab_internal_rows" align='left'><b>Upload Photos</b><br><span><span style="font-weight:bold;font-size:10px;color:red;">('gif' , 'jpg' , 'jpeg' , 'png' , 'bmp')</span>
