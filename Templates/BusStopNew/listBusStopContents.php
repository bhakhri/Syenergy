...
?>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" height="20">
    ...
    <!--Start Add Div-->
<?php floatingDiv_Start('AddBusStop','Add Vehicle Stop'); ?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="border">
     <tr>
        ...
        <td width="79%" class="padding" valign='top'><nobr>:
         <select size="1" class="selectfield" name="stopCityName" id="stopHeadName" onchange="addNewStopCity(this.value,'newCity','cityName')">
		
        </select></nobr>
        <div style="padding:5px 0px 0px 7px;display:none;" id='newCity' ><input type="text" id="cityName" name="busStopcity" onfocus="removeInsertDefault(this.value,this.id)" onblur="removeInsertDefault(this.value,this.id)" class="inputbox" maxlength="30" /></div>
        </td>
...
<!--Start Edit Div-->
<?php floatingDiv_Start('EditBusStop','Edit Vehicle Stop'); ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="border">
    <input type="hidden" name="busStopId" id="busStopId" value="" />
      <tr>
        <td width="21%" class="contenttab_internal_rows" valign='top'><nobr><b>Vehicle Stop City<?php echo REQUIRED_FIELD;?></b></nobr></td>
        <td width="79%" class="padding" valign='top'><nobr>:
         <select size="1" class="selectfield" name="stopCityName" id="stopHeadName" onchange="addNewStopCity(this.value,'editNewCity','editCityName')">
        </select></nobr>
        <div style="padding:5px 0px 0px 7px;display:none;" id='editNewCity' ><input type="text" id="editCityName" name="busStopcity" onfocus="removeInsertDefault(this.value,this.id)" onblur="removeInsertDefault(this.value,this.id)" value="Enter City Name" class="inputbox" maxlength="30" /></div>
        </td>
    </tr>
        </td>
    <tr>
