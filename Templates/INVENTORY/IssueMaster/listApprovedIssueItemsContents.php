...
<!--Start Add Div-->
<?php floatingDiv_Start('EditRequisition','Issue Items'); ?>
<form name="EditRequisition" action="" method="post">
	...
	<tr>
        <td><div id="issuedRequisitionDiv" style="display:none;overflow:auto;height:350px;width:350px" ></div></td>
	</tr>
	<tr><td height="5px" colspan="3"></td></tr>
        <tr>
            <td align="center" style="padding-right:10px" colspan="3">
			<input type="image" name="imageField" title ="Approve" src="<?php echo IMG_HTTP_PATH;?>/approve.gif" onClick="issuedRequisition();return false;" />
