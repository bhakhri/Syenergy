...
<!--Start Add Div-->
<?php floatingDiv_Start('EditGeneratedPO','Edit Generated PO'); ?>
    <table width="98%" border="0" cellspacing="0" cellpadding="0" class="border">
	...
	<tr>
		<td colspan="6">
		<div id="repairDetail" style="height:300px;overflow:auto;"></div>
	</td>
   ...
   <tr>
	...
	<tr>
		...
		<input type="image" name="approve" src="<?php echo IMG_HTTP_PATH;?>/approve.gif" onClick="return validateAddForm(EditPO,'Edit');return false;" />
		<input type="image" name="addCamcel" src="<?php echo IMG_HTTP_PATH;?>/cancel.gif"  onclick="javascript:hiddenFloatingDiv('EditGeneratedPO');if(flag==true){sendReq(listURL,divResultName,searchFormName,'');flag=false;}return false;" />
