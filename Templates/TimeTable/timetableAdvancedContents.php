																...
																<table border="0" cellspacing="0" cellpadding="0" >
																	...
																	<tr>
																		...
																		<td  align="left" style="padding-right:5px" colspan="6">
																			<input type="image" name="imgSubmit" src="<?php echo IMG_HTTP_PATH;?>/showtimetable.gif" onclick="return validatetTimetableForm('validate');" /></td>
																			<!--<input type="image" name="imgSubmit" src="<?php echo IMG_HTTP_PATH;?>/show_adjustments.gif" onclick="return showAdjustments();" />-->
                                                                           <td> <input type="image" name="imgSubmit" src="<?php echo IMG_HTTP_PATH;?>/show_subject_list.gif" onclick="showClassSubjects();" />
																		</td>
																	</tr>
                                                                    <tr id="periodRow">
