																...
																<table border="0" cellspacing="0" cellpadding="0" >
																	...
																	<tr>
																		...
																		<td align="left" class="padding" >
																			<select name="periodSlotId" id="periodSlotId" class="inputbox1" onChange="cleanUpTable();hideAddRow();getTimeTablePeriodSlotPopulate();">
																		...
																		<td class="padding">
																			<select size="1" name="timeTableLabelId" id="timeTableLabelId" class="inputbox1" onChange="hideAddRow();cleanUpTable();getTimeTableClasses();">
																			<option value="">Select</option>
																			<?php
																				require_once(BL_PATH.'/HtmlFunctions.inc.php');
																		...
																		<td class="padding">
																			<select size="1" name="studentClass" id="studentClass" class="inputbox1" style="width:280px;" onChange='hideAddRow();cleanUpTable();getSubjectsGroups();'>
																			<option value="">Select</option>
																			<?php
																				//require_once(BL_PATH.'/HtmlFunctions.inc.php');
                                                                        ...
                                                                        <td class="padding">
	                                                                        <select class="inputbox1" size="1" name='subjectHidden' id='subjectHidden' style="width:170px">
		                                                                        <option value="">Select</option>
	                                                                        </select>
                                                                        </td>
                                                                        </tr>
                                                                    ...
                                                                    <tr id="periodRow">
                                                                      <td valign='top' colspan='15' class="contenttab_internal_rows"  width="80%">
                                                                        <div id="periodRowDiv" style="overflow:auto; width:1000px;"></div>
                                                                      </td>
                                                                    </tr>
																	<tr>
																		<td height="5px">
																...
																<table width="100%" border="0" cellspacing="2" cellpadding="0" id="anyid">
																	<tbody id="anyidBody">
																		<tr class="rowheading">
																			...
																			<td width="7%" class="searchhead_text"><b>Mon</b></td>
...
<?php
// $History: timetableAdvancedContents.php $
//
//*****************  Version 18  *****************
