...
//--------------------------------------------------------
    ...
    $conditions  = " AND ttl.timeTableType=$timeTableType AND tt.roomId=".$roomId." AND tt.timeTableLabelId=".$timeTableLabelId;
 ...
 //Report generate
   function reportGenerate($value,$heading) {
        ...
        $reportManager->setReportHeading('Room wise Time Table Report');
...
<?php 
// $History: roomWiseTimeTablePrint.php $
//
//*****************  Version 6  *****************
