<?php 
//This file is used as printing version for class wise timetable.
//
...
//--------------------------------------------------------
    ...
    $conditions  = " AND ttl.timeTableType=$timeTableType AND cl.classId=".$classId." AND tt.timeTableLabelId=".$timeTableLabelId;
    ...
    $foundArray = $studentManager->getSingleField('class', 'className', "WHERE classId  = ".$classId);
    $className = $foundArray[0]['className'];
 ...
 //Report generate
   function reportGenerate($value,$heading) {
        ...
        $reportManager->setReportHeading('Class wise Time Table Report');
...
<?php 
// $History: classWiseTimeTablePrint.php $
//
//*****************  Version 4  *****************
