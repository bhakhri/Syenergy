        ...
        <td valign="top">
            ...
            <tr>
             ...
             <td valign="top" class="contenttab_row" style="border-bottom-style:none;">
              ...
              <nobr>
               <div id="subjectDiv">
                <b>Subject : </b><input type="text" name="msgSubject" id="msgSubject" class="inputbox" style="width:434px" maxlength="100">
               </div> 
              </nobr> 
              </td>
             ...
             <tr>
                ...
                <form name="employeeDetailsForm" id="employeeDetailsForm" action="<?php echo HTTP_LIB_PATH;?>/AdminMessage/employeeFileUpload.php" method="post" enctype="multipart/form-data" style="display:inline" onSubmit="return false;">
                 <table width="100%" border="0" cellspacing="0" cellpadding="0"  >
                 <tr>
                 <td>
