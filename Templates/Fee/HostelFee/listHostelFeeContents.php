            ...
            <tr>
             ...
             <tr>
                <td class="contenttab_border" height="20">
                    ...
                    <tr>
                        <td class="content_title">Hostel Fee Master: </td>
                 ...
                 <table width="10%" border="0" cellspacing="0" cellpadding="0" >
                    <tr>
                        <td class="contenttab_internal_rows" align="left" style="padding-left:5px" valign='top'>
                           <nobr><b>Hostel</b><?php echo REQUIRED_FIELD;?></nobr>
                        </td>
                        <td  class="contenttab_internal_rows" valign="top"><b>:</b></td>        
                        <td class="contenttab_internal_rows" align="left" valign='top' width="10%" nowrap >
                        <select  name="hostelId[]" id="hostelId" style="width:270px" onchange="getHostelRoomType();resetForm('restAll');" multiple size="4" class="selectfield" >
                         <?php
                          require_once(BL_PATH.'/HtmlFunctions.inc.php');
                          echo HtmlFunctions::getInstance()->fetchHostels();
                         ?>
                        </select>
                        <br/><span class="contenttab_internal_rows">
                            Select &nbsp;<a class='allReportLink' onclick="makeSelection('hostelId[]','All','searchForm');resetForm('restAll');getHostelRoomType();" href='javascript:void(0)'>All</a> / <a class='allReportLink' onclick="makeSelection('hostelId[]','None','searchForm');resetForm('restAll');" href='javascript:void(0)';>None</a>
                            </span>
                        </td>
                       <td class="contenttab_internal_rows" align="left" style="padding-left:15px" width="2%" nowrap valign='top'>
                        <nobr><b>Room Type<?php echo REQUIRED_FIELD;?></b></nobr>
                       </td>
                       <td  class="contenttab_internal_rows" valign="top"><b>:</b></td>        
			           <td class="padding" valign='top'>
                         <select size="1"  name="roomTypeId" style="width:270px" id="roomTypeId" class="selectfield" onchange="resetForm('');">
                            ...
                            <table width="10%" border="0" cellspacing="0" cellpadding="0" > 
                              <tr>
                                  <td class="contenttab_internal_rows" nowrap> 
                                    ...
                                    <input name="classStatus" id="classStatus1" value="3" onClick="resetForm('restAll');getAllDegree('all');" type="radio">Past&nbsp;
                                  </td>
                    ...
                    <div  id='feeTextBoxDiv' style='display:none'>
                          <br/>
                     <fieldset>
    			<legend class="contenttab_internal_rows"><strong>Hostel Fee&nbsp;:</strong></legend>
                    <table cellspacing=0 cellpadding=0 border=0 width='100%'>
                    	<tr > 	
                    	<td class="contenttab_internal_rows" align="left" style="padding-left:5px;" width="10%"><nobr><b>Room Rent</b></nobr></td>
			<td  width=1% align='center'><b>: </b></td>
			<td class="padding" align="left" width="23%">
			<input type='text' name='fillRoomRent' onchange="fillTextBox(this.value)" style="width:180px;text-align:right;" id='fillRoomRent'>
			</td>
