<?php
        ...
        if($receiptId==''){
         $imageButton1 = '<input type="image"  src="'.IMG_HTTP_PATH.'/print.gif" onClick="printout(); return false;" title="Print">';
        }
		...
		$condition='';    
        if($receiptId!=''){
			 $condition = " AND frd.receiptNo ='$receiptId'  ";		
		}
        else{
...
$condition1 = '';
if($receiptId != ''){
  $condition = "  AND frd.isDelete=0 AND frd.feeType ='$feeType'";
}
...
if(count($feeDataArray) == 0){
  echo "";
                 ...
                 <tr>
                    <td class='dataFont' style='padding-top:4px' align='left' colspan='2'>
                      ...
                      <tr>
                           ...
                           <td class='dataFont' width='5%' style='padding-left:8px;' rowspan='4' nowrap>
                              <table border='0' cellspacing='0' cellpading='0' align='right'> 
                                <tr>
                                  <td class='dataFont' nowrap>Father's Name</td>
     ...
     else if($onlineId =='0' && $receiptId =='0' ){
         echo $paymentReceiptPrint = "<table border='0px' cellpadding='0px' cellspacing='0px' align='center'>
               <tr>
                 <td align='center'><strong> NO FEE DUE </strong></td> 
               </tr>
               <tr><td><br></td></tr>                
               </table>";  
     }
