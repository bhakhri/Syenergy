                         ...
                         <tr>
                            <td class="contenttab_border2" align="center">
                             ...
                             <table border="0" cellspacing="0" cellpadding="0px" width="10%" align="center">
                             	<tr>	<td class="contenttab_internal_rows" nowrap width="2%" ><nobr><B><font color='red'>
	                                    	Report For</font></B></nobr>
	                                    </td>
	                                    <td class="contenttab_internal_rows" nowrap width="2%"><B>&nbsp;:&nbsp;</B></td>
	                                    <td class="contenttab_internal_rows" ><nobr>
									     <input type="radio" name="paidReport" id="paid1" value="0" checked >Paid Fee&nbsp;&nbsp;
									      <input type="radio" name="paidReport" id="paid2" value="1" >Unpaid Fee&nbsp;&nbsp;
									    </nobr>
								    </td>
							  
								    <td class="contenttab_internal_rows" nowrap width="2%" ><nobr><B><font color='red'>
	                                    	&nbsp;Fee Of</font></B></nobr>
	                                    </td>
	                                    <td class="contenttab_internal_rows" nowrap width="2%"><B>&nbsp;:&nbsp;</B></td>
	                                      <td class="contenttab_internal_rows" colspan="10"><nobr>
	                                      	<input type="radio" name="feeReport[]" value="3" id="fee4" checked >Hostel Fee&nbsp;&nbsp;
	                                      	<input type="radio" name="feeReport[]" value="2" id="fee3">Transport Fee&nbsp;&nbsp;
	                                      	<input type="radio" name="feeReport[]" id="fee2" value="1" >Academic Fee&nbsp;&nbsp;
									       <input type="radio" name="feeReport[]"  id="fee1" value="4" >Paid for(Hostel+Transport+Academic)&nbsp;&nbsp;</B>
									     </nobr>
								    </td>	                                     
								</tr>
