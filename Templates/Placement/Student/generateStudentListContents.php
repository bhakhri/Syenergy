            ...
            <tr>
             ...
             <tr>
                <td class="contenttab_border" height="20">
                    ...
                    <tr>
                        <td class="content_title">Generate Student List : </td>
             ...
             <tr>
                ...
                <form name="searchForm" action="" method="" style="display:inline" onsubmit="return false;" >
                   <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <td class="contenttab_internal_rows" width="2%" nowrap="nowrap"><b>Grace Marks</b></td>
                    <td class="padding" width="1%">:</td>
                    <td class="padding" width="5%">
                      <input type="text" name="graceMarks" id="graceMarks" class="inputbox" maxlength="4" style="width:50px;" disabled="disabled" onchange="vanishData2();" />
                    </td>
                   ...
                   <tr id="saveTRId" style="display:none;"> 
                    <td colspan="7" align="center">
                       <input type="image" name="imageField" src="<?php echo IMG_HTTP_PATH;?>/save.gif" onClick="doEligibilityListing();" />
                    </td> 
                   </tr>
                   </table>
                 </form>  
