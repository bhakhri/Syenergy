...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td valign="top" class="title">
            My Mentees&nbsp;&raquo;&nbsp;Student Registration Report
        </td>
    </tr>
    <tr>
        <td valign="top">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="contenttab_border2">
                            <tr>
                                <td valign="top" class="contenttab_row1">
                                        <table align="left" border="0" cellpadding="2px" cellspacing="2px"  width="20%">
                                           <tr>
                                                <td colspan="1" class="contenttab_internal_rows" valign="middle" align="left"><nobr><b>Roll No.</nobr></b></td>
                                                ...
                                                <td colspan="1" class="contenttab_internal_rows" style="padding-left:10px;" valign="middle"  align="left">
                                                ...
                                                <td class="" valign="middle" align="left" ><nobr>
                                                  ...
                                                  <input checked="checked" id="registered2" name="registered" value="2" type="radio"></span></nobr><nobr>&nbsp;<span style="color: red;">Pending</span>
                                                  <span style="padding-left: 5px;">
                                                  <input id="registered3" name="registered" value="3" type="radio"></span></nobr><nobr>&nbsp;Both</nobr>
                                                </td>
                                                <td align="left" colspan="10" style="padding-left:20px" >
                                                    <input type="image" name="mSubmit" value="mSubmit" src="<?php echo IMG_HTTP_PATH;?>/showlist.gif" onClick="return validateRegistrationForm(this.form);return false;" />
                                                </td>    
                                            </tr>
                                        </table>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" height="20"  class="">
                                        <tr>
                                            <td width="80%" nowrap class="content_title" align="center" style="padding-left:160px;display:none">
                                                <input type="image" name="imageField" alt="Approve" title="Approve" src="<?php echo IMG_HTTP_PATH; ?>/approve.gif" onClick="printReport();return false;"/>&nbsp;&nbsp;
                                                <input type="image" name="Cancel" alt="Cancel" title="Cancel" src="<?php echo IMG_HTTP_PATH;?>/cancel.gif"  onclick="hideResults(); return false;" />
                                            </td>
