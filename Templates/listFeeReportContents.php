...
<tr>
	<td <?php echo $showPendingReceipt; ?> class="contenttab_internal_rows" valgin="top" nowrap width="2%" ><nobr><b><font color='red'>Fee Of</font></b></nobr></td>
	<td <?php echo $showPendingReceipt; ?> class="contenttab_internal_rows" valgin="top" nowrap width="2%" ><nobr><b>&nbsp;:&nbsp;</b></nobr></td> 
	<td  <?php echo $showPendingReceipt; ?> class="contenttab_internal_rows" nowrap width="2%" colspan="10">  
	  <input id="feeAll" name="paidFee" value="0" checked="checked"  type="radio">&nbsp;All&nbsp;&nbsp;
	  <input id="feeAcademic" name="paidFee" value="1" type="radio">&nbsp;Academic&nbsp;&nbsp;
	  <input id="feeTransport" name="paidFee" value="2" type="radio">&nbsp;Transport&nbsp;&nbsp;
	  <input id="feeHostel" name="paidFee" value="3" type="radio">&nbsp;Hostel&nbsp;&nbsp;
	   <input id="feeCombined" name="paidFee" value="4" type="radio">&nbsp;Both (Academic + Transport + Hostel)&nbsp;&nbsp;
	</td>
</tr>
