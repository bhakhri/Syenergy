...
//--------------------------------------------------------
	...
	/* END: search filter */
	$conditions = "  AND cls.classId =$classId";
    $recordArray = $dashboardManager->getStudentEnquiryDegreeRecords($conditions," ORDER BY sc.enquiryDate DESC");
	...
	$className =$recordArray[0]['className'];
	$reportManager->setReportWidth(665);
	$reportManager->setReportHeading('Student List for Class '.$className);
...
// $History: studentDegreeEnquiryReportPrint.php $
//
//*****************  Version 1  *****************
