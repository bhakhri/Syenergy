...
//--------------------------------------------------------
	...
	/* END: search filter */
	$conditions = "  AND usr.userId =$userId";
    $recordArray = $dashboardManager->getStudentEnquiryConsolerRecord($conditions," ORDER BY sc.enquiryDate DESC");
	...
	$reportManager->setReportHeading('Student List for Counselor '.$userName);
...
// $History: studentConsularEnquiryReportPrint.php $
//
//*****************  Version 2  *****************
...
//
//*****************  Version 1  *****************
//User: Rajeev       Date: 6/03/09    Time: 12:11p
