...
//
//--------------------------------------------------------
include(MODEL_PATH . "/CityManager.inc.php");
            ...
            <tr>
             ...
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr height="30">
                                ...
                                <td width="14%" class="contenttab_border" align="right" nowrap="nowrap" style="border-left:0px;margin-right:5px;"><img src="<?php echo IMG_HTTP_PATH;?>/add.gif" onClick="displayWindow('AddCity',315,250);blankValues();return false;" />&nbsp;</td></tr>
             <tr>
