...
<?php    
   ...
   // Find Student    
    $studentCondition = " AND c.classId = $degree AND tt.subjectId = $subjectId AND tt.groupId = $groupId AND tt.timeTableLabelId='".$timeTableLabelId."'"; 
                         ...
                         // $bg = $bg =='trow0' ? 'trow1' : 'trow0';    
                          ...
                          if($dt<$countColumns) {
                            for($j=$dt; $j<$countColumns; $j++) {
                              $tableData .= "<td width='5%' valign='top' ".$reportManager->getReportDataStyle()."  align='center'>".$blankSymbol."</td>";  
                            }
                          }
...
//
//*****************  Version 14  *****************
//User: Parveen      Date: 4/12/10    Time: 11:20a
//Updated in $/LeapCC/Templates/AdminTasks
...
//
//*****************  Version 8  *****************
//User: Parveen      Date: 3/17/10    Time: 12:27p
//Updated in $/LeapCC/Templates/AdminTasks
