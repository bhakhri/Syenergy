...
?>    <form onSubmit="sendReq(listURL,divResultName,searchFormName,'');return false;" name="searchForm">  
    ...
    <tr>
        <td valign="top" class="title">
            ...
            <tr>
                <td valign="top">Setup&nbsp;&raquo;&nbsp;Fee Masters&nbsp;&raquo;&nbsp;Bank Master</td>
            ...
            <tr>
             ...
             <tr>
                <td class="contenttab_border" height="20">
                    ...
                    <tr>
                        <td class="content_title">Bank Details : </td>
                        <td class="content_title" title="Add">
						<img src="<?php echo IMG_HTTP_PATH;?>/add.gif" 
                        align="right" onClick="window.location='<?php echo UI_HTTP_PATH;?>/payrollCreateStructureAdd.php'" />&nbsp;</td>
                    </tr>
                    </table>
                </td>
             </tr>
...
<?php floatingDiv_Start('AddStructure','Add Structure'); ?>
<form name="addStructure" action="" method="post">
	<table width="580" border="0" cellspacing="0" cellpadding="0" class="border" align="center">
		<tr>
			<td class="contenttab_internal_rows" width="20%"><strong>&nbsp;&nbsp;Institute<?php echo REQUIRED_FIELD ?></strong></td>
			<td width="80%" class="padding" align="left">&nbsp;
			<!-- <input type="text" maxlength="100" id="bankName" name="bankName" style="width:142px" /> -->
             <select name="instituteId" id="instituteId" style="width:142px">
		...
		<tr>
			<td class="contenttab_internal_rows" width="20%"><strong>&nbsp;&nbsp;Financial Year<?php echo REQUIRED_FIELD ?></strong></td>
			<td class="padding" align="left" width="80%">&nbsp;
			 <select name="financialYear" id="financialYear" style="width:142px">
             <option value="" selected="selected">Select</option>
        ...
        <tr>
        <td colspan=2 class="contenttab_row" valign="top">
        <table width="580" border="0" cellspacing="2" cellpadding="0" id="anyid">
            <tbody id="anyidBody">
              <tr class="rowheading">
                 <td width="2%" class="searchhead_text"><b>Sr.</b></td>
                 <td width="22%" class="searchhead_text"><b>Head Title</b></td>
                 <td width="22%" class="searchhead_text"><b>Type</b></td>
                 <td width="22%" class="searchhead_text"><b>Deduction A/C</b></td>
                 <td width="22%" class="searchhead_text"><b>Amount(Rs)</b></td>
        ...
        <td colspan=2>
            ...
            <div id='addRowDiv' >
            <h3>&nbsp;&nbsp;Add Rows:&nbsp;&nbsp;<a href="javascript:addOneRow(1);" title="Add One Row"><b>+</b></a></h3></div>
        </td>
        </tr>
		<tr>
			<td height="5px"></td></tr>
...
<form name="editBank" action="" method="post">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="border">
			...
			<tr>
				<td class="contenttab_internal_rows" width="40%"><strong>&nbsp;&nbsp;Bank Name<?php echo REQUIRED_FIELD ?></strong></td>
			...
			<tr>
				...
				<input type="text" maxlength="10" id="bankAbbr" name="bankAbbr" style="width:142px" />
				</td>
			</tr>
			<tr>
				<td height="5px"></td>
