...
?>
    ...
    <tr>
        <td valign="top" class="title">
            ...
            <tr>
                <td valign="top">Fee&nbsp;&raquo;&nbsp;Collect Fees</td>
            </tr>
            </table>
        </td>
    </tr>
    <tr>
						...
						<td valign="top" width="35%">
							...
							<tr>
								...
								<tr>	
									...
									<td><?php //echo $studentFeeReceiptNo ?><input type="text" id="receiptNumber" name="receiptNumber" class="inputbox1" value="<?php echo $receiptNo?>" style="width:75px" onkeypress="return sendKeys('feeType',event);"/>
									</td>
								</tr>
								<tr>
								...
								<tr>	
									...
									<td class="contenttab_internal_rows"><B>:</B></td>
									<td><select size="1" name="feeType" id="feeType"  onChange="populateValues()" class="inputbox1" onkeypress="return sendKeys('studentRoll',event);">
		...
		onClick="showStudentDetails('getStudentDetail',850,100); blankValues();return false;" ><u>Search Student</u></a><td>
								...
								<tr>	
									...
									<td class="contenttab_internal_rows"><B>:</B></td>
									<td><select size="1" name="feeCycle" id="feeCycle"  onChange="populateValues()" class="inputbox1" onkeypress="return sendKeys('feeStudyPeriod',event);">
								...
								<tr>	
									<td class="contenttab_internal_rows"><nobr><B>Fees Study Period</B><?php echo REQUIRED_FIELD?></nobr></td>
									<td class="contenttab_internal_rows"><B>:</B></td>
