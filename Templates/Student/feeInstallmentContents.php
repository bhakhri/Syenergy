<?php
//-------------------------------------------------------
// Purpose: to design the layout for installment detail.
//
...
?>
    ...
    <tr>
        <td valign="top" class="title">
            ...
            <tr>
                <td valign="top">Financial&nbsp;&raquo;&nbsp;Fee Collection Reports&nbsp;&raquo;&nbsp;Installment Details of Students</td>
            </tr>
            </table>
        </td>
    </tr>
...
<?php 
// $History: feeInstallmentContents.php $
//
//*****************  Version 1  *****************
