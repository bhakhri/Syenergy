<?php 
//This file is used as printing version for branch wise student report for management role.
//
...
//--------------------------------------------------------
    ...
    $recordArray = $dashboardManager->getStudentBranchWiseList($conditions,$orderBy);
	...
	$reportManager->setReportHeading('Student List for '.$branchName.' Branch');
...
// $History: studentBranchReportPrint.php $
//
//*****************  Version 1  *****************
//User: Rajeev       Date: 09-08-18   Time: 3:11p
//Created in $/LeapCC/Templates/Student
//intial checkin
//
//*****************  Version 1  *****************
//User: Rajeev       Date: 11/11/08   Time: 1:02p
