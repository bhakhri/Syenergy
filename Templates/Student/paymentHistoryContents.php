              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="5" height="405">
                <tr>
                 ...
                 <tr>
					...
					<tr>
						<td valign="top" class="contenttab_row1" colspan="10" align='left'>
						...
						<tr>
					        ...
					        <td valign="middle" style="padding-left:20px" nowrap>
					            <B>Show No. of Records in Report:</B>&nbsp;
					        </td>
					        <td valign="middle"  nowrap>
					 			<input  id="totalRecords" name="totalRecords" type="text" class="inputbox1" maxlength="5" value="100" style="width:50px">
					        </td>	
					        <td valign="middle" style="padding-left:20px" nowrap><nobr>
					        	 <input type="checkbox" id="isSort" name="isSort" value="1" checked="true"/>&nbsp;&nbsp;Combine Sort(Name, Class)					        	 
					        </nobr></td>
