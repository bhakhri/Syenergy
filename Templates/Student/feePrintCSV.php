...
//--------------------------------------------------------
    ...
    $csvData .= "#,Receipt Date,Receipt,Fee Class,Fee Cycle,Installment,Payable(Rs.),Paid(Rs.),Outstanding(Rs.),Instrument,Status";
    $csvData .= "\n";
    ...
    UtilityManager::makeCSV($csvData,'FeeReportPrint.csv');
    die;
