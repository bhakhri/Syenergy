	...
	<tr>
		<td valign="top" class="title">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					<td valign="top" colspan="2">Accounts&nbsp;&raquo;&nbsp;Reports&nbsp;&raquo;&nbsp;Trial Balance</td>
				</tr>
			</table>
		</td>
	</tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contenttab_border2">
							<tr>
								<td valign="top" class="contenttab_row1">
									<form name="trialBalanceForm" action="" method="post" onSubmit="return false;">
										<table align="center" border="0" cellpadding="0">
											<tr>
												...
												<td colspan='1' class='' align="left">
												<strong>&nbsp;&nbsp;Show:</strong>&nbsp;
												<select name='groupLedger' class='inputbox'>
												<?php 
												require_once(BL_PATH.'/HtmlFunctions.inc.php'); 
												echo HtmlFunctions::getInstance()->makeGroupLedgerSelectBox($REQUEST_DATA['groupLedger']);
												?>
												</select>
												</td>
							...
							<tr id='nameRow' style='display:none;'>
								<td class="" height="20">
									<table width="100%" border="0" cellspacing="0" cellpadding="0" height="20"  class="contenttab_border">
										<tr>
											<td colspan="1" class="content_title">Trial Balance :</td>
...
<?php
// $History: listTrialBalanceReport.php $
//
//*****************  Version 1  *****************
