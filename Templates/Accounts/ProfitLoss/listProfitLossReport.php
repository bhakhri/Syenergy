	...
	<tr>
		<td valign="top" class="title">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					<td valign="top" colspan="2">Accounts&nbsp;&raquo;&nbsp;Reports&nbsp;&raquo;&nbsp;Profit & Loss Account</td>
				</tr>
			</table>
		</td>
	</tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="contenttab_border2">
							<tr>
								<td valign="top" class="contenttab_row1">
									<form name="profitLossForm" action="" method="post" onSubmit="return false;">
							...
							<tr id='nameRow' style='display:none;'>
								<td class="" height="20">
									<table width="100%" border="0" cellspacing="0" cellpadding="0" height="20"  class="contenttab_border">
										<tr>
											<td colspan="1" class="content_title">Profit & Loss Account :</td>
...
<?php
// $History: listProfitLossReport.php $
//
//*****************  Version 1  *****************
