                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" height="20" class="contenttab_border" >
                        <tr>
                            <td class="content_title" align="left">Assign Final Grade Details :</td>
                        </tr>
                    </table>
            <tr>
                <td class="contenttab_border2" valign="top" >   
                   <!-- <div class="searchhead_text" align="left">Add Rows:&nbsp;&nbsp;
                    ...
                    <input type="hidden" name="finalGradeId" id="finalGradeId" value="" />                        
                     <table class="padding" width="100%" border="0"  id="anyid">
                            <tbody id="anyidBody">
                              <tr class="rowheading">
                                <td class="searchhead_text" width="6%"  align="left"><nobr><b>#</b></nobr></td>
                                <td class="searchhead_text" width="15%" align="left"><nobr><b>Grade Point From</b></nobr></td>
                                <td class="searchhead_text" width="15%" align="left"><nobr><b>Grade Point To</b></nobr></td>
                                <td class="searchhead_text" width="15%" align="left"><nobr><b>Grade</b></nobr></td>
                                <td class="searchhead_text" width="15%" align="left"><nobr><b>Grade Points</b></nobr></td>
