...
<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr height="30">
								<td class="contenttab_border" height="20" style="border-right:0px;">
									<form action="" method="" name="searchForm" onSubmit="document.searchForm.searchbox.value=document.searchForm.searchbox_h.value; sendReq(listURL,divResultName,searchFormName,''); return false;" <?php echo $style;?>>
    ...
    ?>
        <tr height="30">
            ...
            <td align="left">
                <img  src="<?php echo IMG_HTTP_PATH;?>/search1.gif" style="margin-right: 5px;margin-top:0px;" onClick="document.searchForm.searchbox.value=document.searchForm.searchbox_h.value; sendReq(listURL,divResultName,searchFormName,''); return false;"/>
  ...
  <tr height="30">
            ...
            <td align="left">
                <img src="<?php echo IMG_HTTP_PATH;?>/search1.gif" style="margin-right:5px;margin-top:4px;height:20px;border:0px" onClick="document.searchForm.searchbox.value=document.searchForm.searchbox_h.value; sendReq(listURL,divResultName,searchFormName,''); return false;"/>
                <input type="hidden" name="searchbox" value="<?php echo $REQUEST_DATA['searchbox'];?>" />
            </td>
        </tr>
    <?php
