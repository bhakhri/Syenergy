		...
		echo HtmlFunctions::getInstance()->getClassWithStudyPeriod($REQUEST_DATA['degree']==''?$REQUEST_DATA['degree'] : $REQUEST_DATA['degree']);
											...
											<tr>
												...
												<td valign="top" rowspan='1'>&nbsp;
													<input type="file" id="studentDetailUploadFile" name="studentDetailUploadFile" class="inputbox1" <?php echo $disableClass?>/>
												...
												<td colspan="3" valign="top" style="padding-left:30px">
													<input type="image" name="studentListSubmit" value="studentListSubmit" src="<?php echo IMG_HTTP_PATH;?>/upload.gif" onClick="submitForm('upload');" />
                                                 
                                                 <input type="image" name="studentListSubmit1" value="studentListSubmit1" src="<?php echo IMG_HTTP_PATH;?>/update.gif" onClick="submitForm('update');" />   
                                                   <!-- <input type="button" name="button" id="button" value="Update" onClick="submitForm('update');" />     -->
										       </td>
											</tr>
                                            <tr><td height="10px"></td></tr>
                                            <tr>
...
<input value='1'   id="ignoreDuplicateRollUniv" name="ignoreDuplicateRollUniv" type="checkbox">Ignore Duplicate Roll No./Univ No.
    ...
    <td>
<input value='1'   id="addressValid" name="addressValid" type="checkbox">Ignore State, City, Country Validation<br>
</td>
</tr>
<tr>
<td>
...
<tr>
 <td colspan="3">
        <span style="font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 10px; color: red;"> 
          <b>*&nbsp;</b>Automatically remove spaces in between Roll No./University Roll No./Reg. No. 
        </span> 
    </td>
</tr>
</table>
                                          ...
                                          <td class="contenttab_internal_rows" align="left" colspan="20">
                                              ...
                                              <table width="100%" border="0px" cellpadding="0" cellspacing="0">
                                               <!--<tr style="display:none">-->
                                                   <td class="contenttab_internal_rows" nowrap colspan="20" height="30px" valign="top">  
...
<div id="OverDiv12" style="overflow:auto; width:960px; height:200px">
 <div id="Over2Div">
<table border="1" cellpadding="0" cellspacing="0" width="100%">
			...
			<b><font color="red">3.Don't forget to put the [ ] brackets </font></b><br/>
