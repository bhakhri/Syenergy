...
function isStudentBlocked($userId,$roleId){
  ...
  return $returnValue;
	...
	$reportManager->setReportHeading('Feedback Assign Survey Report (Advanced)<br/>UBA : Unblocked By Administrator');
    ...
    $reportTableHead['status']              =   array('Completed','width="5%" align="left" ', 'align="left"');
    $reportTableHead['isBlocked']           =   array('Blocked','width="5%" align="left" ', 'align="left"');
