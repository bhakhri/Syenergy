                   ...
                   <tr>
                     ...
                     <td class="padding">
                       ...
                       <option value="">Select</option>
                         ...
                         <td class="contenttab_internal_rows" style="padding-left:3px;"><b>Status</b></td>
                        <td class="contenttab_internal_rows"><b>:</b></td>
                        <td>
                             <select name="comptype" id="comptype" class="htmlElement" style='width:200px'  >
		              <option value="">All</option>
		              <option value="Pending">Pending</option>
		              <option value="Completed">Completed</option>
		              <option value="Partial">Partial</option>
		             </select>
                     <b> &nbsp;Applicable To&nbsp;:&nbsp;<div id="applicableToTDId" style="display:inline"><?php echo $blank_string; ?></b>
                     </td>
