            ...
            <tr>
             ...
             <tr>
                <td class="contenttab_border" height="20">
                    ...
                    <tr>
                        <td class="content_title">Feedback Class Final Report (Advanced) : </td>
                 ...
                 <td colspan="7" nowrap="nowrap">
                     <table border="0"  cellspacing="0" cellpadding="0">
                       <tr>
                        ...
                        <td class="padding">:</td>
                        <td class="padding">
                         <select name="classId" id="classId" class="inputbox" style="width:220px;" onchange="getEmployees(document.allDetailsForm.timeTableLabelId.value,document.allDetailsForm.labelId.value,this.value);">
                          <option value="">Select</option>
                         </select>
                        </td>                        
                        ...
                        <td class="padding">:</td>
                        <td class="padding">
                         <select name="employeeId" id="employeeId" class="inputbox" style="width:180px;" onchange="vanishData();">
