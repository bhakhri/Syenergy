...
set_time_limit(0);
  ...
  if(trim($REQUEST_DATA['labelId'] ) != '' and trim($REQUEST_DATA['timeTableLabelId'] ) !='') {
    ...
    $reportManager->setReportInformation("Time Table : ".trim($REQUEST_DATA['timeTableName']).", Label : ".trim($REQUEST_DATA['labelName']).',  Teacher : '.trim($REQUEST_DATA['teacherName']).',  Category : '.trim($REQUEST_DATA['categoryName']));
