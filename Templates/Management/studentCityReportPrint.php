<?php 
//This file is used as printing version for city wise student report for management role.
//
...
//--------------------------------------------------------
	...
	/* END: search filter */
	$conditions = "  AND cty.cityId =$cityId";
    $recordArray = $dashboardManager->getStudentCityWiseList($conditions,$orderBy);
...
// $History: studentCityReportPrint.php $
//
//*****************  Version 1  *****************
//User: Rajeev       Date: 5/30/09    Time: 6:36p
