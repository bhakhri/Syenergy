<?php 
//This file is used as printing version for section wise student report for management role.
//
...
//--------------------------------------------------------
    ...
    $recordArray = $dashboardManager->getStudentSectionWiseList($conditions,$orderBy);
	...
	$reportManager->setReportHeading('Student List for '.$sectionName.' Section');
	...
	$reportTableHead['subjectCode']	=	array('Course','width=8% align="left"', 'align="left" valign="top"');
...
// $History: scStudentSectionReportPrint.php $
//
//*****************  Version 1  *****************
