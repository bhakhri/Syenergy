<?php 
//-------------------------------------------------------
//  This File contains html form for all details report for class wise subject
//
//
	...
	<tr>
		<td valign="top" class="title">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					<td valign="top" colspan="2">Reports&nbsp;&raquo;&nbsp; Class wise subject details</td>
				</tr>
			</table>
		</td>
	</tr>
			...
			<td valign="top" class="content">
			 ...
			 <tr>
				...
				<script type="text/javascript">
				  ...
				  so.addVariable("data_file", encodeURIComponent("../../Templates/Xml/subjectClasswiseData.xml"));
...
<?php 
//$History: scAllSubjectDetailsReport.php $
//
//*****************  Version 1  *****************
