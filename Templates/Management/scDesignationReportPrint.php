<?php 
//This file is used as printing version for designation wise employee for management role.
//
...
//--------------------------------------------------------
	...
	//employee role
	$designationId = $REQUEST_DATA['designationId'];
	...
	/* END: search filter */
	$conditions = "  AND dsg.designationId =$designationId";
    ...
    for($i=0;$i<$cnt;$i++) {
		...
		$dsgName= $recordArray[$i]['designationName']; 
	...
	$reportManager->setReportHeading('Employee List for '.$dsgName.' Staff');
...
// $History: scDesignationReportPrint.php $
//
//*****************  Version 1  *****************
