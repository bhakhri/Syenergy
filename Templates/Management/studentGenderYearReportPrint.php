...
//--------------------------------------------------------
	...
	//branch Code
	$genderCode = $REQUEST_DATA['branchCode'];
	...
	/* END: search filter */
	$conditions .= " stu.studentGender = '$genderCode' AND YEAR(dateOfAdmission)= $selectedYear";
    $recordArray = $studentAdmissionManager->getGenderList($conditions,'',' cls.className DESC');
	...
	$reportManager->setReportHeading('Student List for '.$genderName.' for '.$selectedYear.' Year');
...
// $History: studentGenderYearReportPrint.php $
//
//*****************  Version 1  *****************
