...
//--------------------------------------------------------
	...
	/* END: search filter */
	$conditions = "  AND br.branchCode ='$branchCode' AND YEAR(dateOfAdmission)= $selectedYear";
    $recordArray = $studentAdmissionManager->getBranchList($conditions,'',' cls.className DESC');
	...
	$reportManager->setReportHeading('Student List for '.$branchCode.' Branch for '.$selectedYear.' Year');
...
// $History: studentBranchYearReportPrint.php $
//
//*****************  Version 1  *****************
