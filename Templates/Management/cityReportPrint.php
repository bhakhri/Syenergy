...
//--------------------------------------------------------
    ...
    $recordArray = $employeeManager->getEmployeeCityWiseList($conditions,$orderBy);
	...
	$reportManager->setReportHeading('Employee List for '.$cityName.' City');
