<?php 
//This file is used as printing version for state wise employee for management role.
//
...
//--------------------------------------------------------
	...
	/* END: search filter */
	$conditions = "  AND sta.stateId =$stateId";
    $recordArray = $employeeManager->getEmployeeStateWiseList($conditions,$orderBy);
	...
	$reportManager->setReportHeading('Employee List for '.$stateName.' State');
