<?php 
//This file is used as printing version for bus route wise student report for management role.
//
...
//--------------------------------------------------------
	...
	/* END: search filter */
	$conditions = "  AND sc.busRouteId =$busRouteId";
    $recordArray = $dashboardManager->getStudentBusRouteWiseList($conditions,$orderBy);
    ...
    for($i=0;$i<$cnt;$i++) {
		...
		$routeName = $recordArray[$i]['routeName'].' ('.$recordArray[$i]['routeCode'].')';
	...
	$reportManager->setReportHeading('Student List for '.$routeName.' Bus Route');
...
// $History: scStudentBusRouteReportPrint.php $
//
//*****************  Version 1  *****************
