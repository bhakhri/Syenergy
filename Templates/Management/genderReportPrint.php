<?php 
//This file is used as printing version for Gender wise employee for management role.
//
...
//--------------------------------------------------------
	...
	/* END: search filter */
	$conditions = "  AND emp.gender ='$genderId'";
    $recordArray = $employeeManager->getEmployeeGenderWiseList($conditions,$orderBy);
	...
	$reportManager->setReportHeading('Employee List for '.$genderRole.' Staff');
