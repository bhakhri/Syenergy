<?php 
//This file is used as printing version for hostel detail wise student report for management role.
//
...
//--------------------------------------------------------
	...
	/* END: search filter */
	$conditions = "  AND sc.hostelId ='$hostelId'";
    $recordArray = $dashboardManager->getStudentHostelDetailWiseList($conditions,$orderBy);
    ...
    for($i=0;$i<$cnt;$i++) {
		...
		$hostelName= $recordArray[$i]['hostelName']; 
	...
	$reportManager->setReportHeading('Student List for '.$hostelName.' Hostel');
...
// $History: scStudentHostelDetailReportPrint.php $
//
//*****************  Version 1  *****************
