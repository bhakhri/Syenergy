<?php 
//This file is used as printing version for study period wise student report for management role.
//
...
//--------------------------------------------------------
	...
	/* END: search filter */
	$conditions = "  AND sp.studyPeriodId =$studyperiodId";
    $recordArray = $dashboardManager->getStudentStudyPeriodWiseList($conditions,$orderBy);
    ...
    for($i=0;$i<$cnt;$i++) {
		...
		$periodName = $recordArray[$i]['periodName'];
	...
	$reportManager->setReportHeading('Student List for '.$periodName.' Period');
...
// $History: scStudyPeriodReportPrint.php $
//
//*****************  Version 1  *****************
