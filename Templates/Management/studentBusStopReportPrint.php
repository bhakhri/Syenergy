...
//--------------------------------------------------------
    ...
    $recordArray = $studentManager->getStudentBusStopWiseList($conditions,$orderBy);
	...
	$reportManager->setReportHeading('Student List for '.$stopName.' Bus Stop');
...
// $History: studentBusStopReportPrint.php $
//
//*****************  Version 1  *****************
