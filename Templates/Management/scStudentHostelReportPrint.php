...
//--------------------------------------------------------
	...
	$conditions = 	$hostelId==0?" AND hostelId IS NULL":"AND hostelId IS NOT NULL";
	$hostelName = 	$hostelId==0?" Day Scholar":"Hostel";
	/* END: search filter */
	//$conditions = "  AND scs.sectionId ='$sectionId'";
    $recordArray = $dashboardManager->getStudentHostelWiseList($conditions,$orderBy);
...
// $History: scStudentHostelReportPrint.php $
//
//*****************  Version 1  *****************
