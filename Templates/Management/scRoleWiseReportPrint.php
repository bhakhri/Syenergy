<?php 
//This file is used as printing version for role wise employee for management role.
//
...
//--------------------------------------------------------
	...
	/* END: search filter */
	$conditions = " AND rol.roleId=$roleId";
    $recordArray = $dashboardManager->getEmployeeRoleWiseList($conditions,$orderBy);
	...
	$reportManager->setReportHeading('Employee List for '.$roleName);
...
// $History: scRoleWiseReportPrint.php $
//
//*****************  Version 1  *****************
