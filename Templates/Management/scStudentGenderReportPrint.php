<?php 
//This file is used as printing version for gender wise student report for management role.
//
...
//--------------------------------------------------------
    ...
    $sortField = (UtilityManager::notEmpty($REQUEST_DATA['sortField'])) ? $REQUEST_DATA['sortField'] : 'sc.studentGender';

	$orderBy="$sortField $sortOrderBy"; 

	/* END: search filter */
	$conditions = "  AND sc.studentGender ='$genderId'";
    $recordArray = $dashboardManager->getStudentGenderWiseList($conditions,$orderBy);
...
// $History: scStudentGenderReportPrint.php $
//
//*****************  Version 1  *****************
