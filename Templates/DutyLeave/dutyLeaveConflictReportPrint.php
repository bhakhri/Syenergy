...
//--------------------------------------------------------
    ...
    $reportManager->setReportInformation("Search By : Time Table : ".$labelName.", Class : ".$className."<br>
                                                     Event : ".$eventName.", Show : ".$showConflictString);
    ...
    $reportTableHead['actionString'] = array('Status','width="5%" align="left" ', 'align="left"');
