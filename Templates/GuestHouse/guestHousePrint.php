...
//--------------------------------------------------------
    ...
    $recordArray = $guestHouseManager->getGuestHouseRequestList($filter,$orderBy,'',2);
	...
	$reportManager->setReportHeading('Request Guest House Allocation');
    ...
    $reportTableHead['arrivalDate']        =   array('Arr. Date','width="10%" align="center" ', 'align="center"');
    $reportTableHead['aTime']        =   array('Arr.Time','width="8%" align="center" ', 'align="center"');
    $reportTableHead['departureDate']      =   array('Dept. Date','width="10%" align="center" ', 'align="center"');
    $reportTableHead['dTime']      =   array('Dept.Time','width="8%" align="center" ', 'align="center"');
    $reportTableHead['isAllocated']        =   array('Status','width="7%" align="left" ', 'align="left"');
