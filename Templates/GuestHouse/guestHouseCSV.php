...
function parseCSVComments($comments) {
 ...
 return $comments; 
    ...
    $csvData .= "#, Booking No., Guest Name, Guest House, Room, Arr. Date, Arr.Time, Dept. Date, Dept.Time, Status \n";
	...
	header('Content-Disposition: attachment;  filename="requestGuestHouse.csv"');
