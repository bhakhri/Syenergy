...
function parseName($value){
  ...
  return $genName;
    ...
    $recordArray = $quarantineStudentManager->getStudentList($conditions,$orderBy,'');
	...
	$reportManager->setReportHeading('Deleted Students Report');
...
// $History: deleteStudentPrint.php $
//
//*****************  Version 3  *****************
