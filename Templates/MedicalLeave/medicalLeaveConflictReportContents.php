            ...
            <tr>
             ...
             <tr>
			  ...
			  <td class="contenttab_internal_rows">
			            ...
			            <td colspan=2 class="contenttab_internal_rows" nowrap>
											...
											<td class="contenttab_internal_rows" align="left" valign="top">
												<fieldset>
													...
													<font color="red">2. The Medical Leaves are ONLY applicable for <u>CONSOLIDATED ATTENDANCE</u> and NOT for Detailed Attendance.</font><br/>
												   	<font color="red">3. The maximum number of Medical Leaves PER SUBJECT cannot be more than: <b><u><?php echo $medicalLeaveLimit=$sessionHandler->getSessionVariable('MEDICAL_LEAVE_LIMIT'); ?></b></u></font><br/>
												   	<font color="red">4. If in any case Medical Leaves more than the above mentioned scenario have to be granted, then this can be done ONLY by the Super admin and he would be alerted. </font><br>
												   	<font color="red">5. If a CONFLICTED Medical Leave is APPROVED then benefit will <b><u>NOT</u></b> be given in the Attendance. </font><br>
<font color="red">6. This Conflict and Non Conflict Report is ONLY applicable for those days for which attendance has been taken. </font>
												</fieldset>
											</td>
										</tr>
										<tr> 
...
<?php floatingDiv_Start('divMessage','Medical Leave Limit Exceeding List','',''); ?>
